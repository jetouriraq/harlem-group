var Ja=Object.defineProperty;var jr=r=>{throw TypeError(r)};var Ya=(r,a,t)=>a in r?Ja(r,a,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[a]=t;var m=(r,a,t)=>Ya(r,typeof a!="symbol"?a+"":a,t),ur=(r,a,t)=>a.has(r)||jr("Cannot "+t);var p=(r,a,t)=>(ur(r,a,"read from private field"),t?t.call(r):a.get(r)),w=(r,a,t)=>a.has(r)?jr("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(r):a.set(r,t),y=(r,a,t,i)=>(ur(r,a,"write to private field"),i?i.call(r,t):a.set(r,t),t),A=(r,a,t)=>(ur(r,a,"access private method"),t);var Hr=(r,a,t,i)=>({set _(n){y(r,a,n,t)},get _(){return p(r,a,i)}});var we={Stringify:1,BeforeStream:2,Stream:3},D=(r,a)=>{const t=new String(r);return t.isEscaped=!0,t.callbacks=a,t},$a=/[&<>'"]/,ca=async(r,a)=>{let t="";a||(a=[]);const i=await Promise.all(r);for(let n=i.length-1;t+=i[n],n--,!(n<0);n--){let o=i[n];typeof o=="object"&&a.push(...o.callbacks||[]);const l=o.isEscaped;if(o=await(typeof o=="object"?o.toString():o),typeof o=="object"&&a.push(...o.callbacks||[]),o.isEscaped??l)t+=o;else{const s=[t];ae(o,s),t=s[0]}}return D(t,a)},ae=(r,a)=>{const t=r.search($a);if(t===-1){a[0]+=r;return}let i,n,o=0;for(n=t;n<r.length;n++){switch(r.charCodeAt(n)){case 34:i="&quot;";break;case 39:i="&#39;";break;case 38:i="&amp;";break;case 60:i="&lt;";break;case 62:i="&gt;";break;default:continue}a[0]+=r.substring(o,n)+i,o=n+1}a[0]+=r.substring(o,n)},da=r=>{const a=r.callbacks;if(!(a!=null&&a.length))return r;const t=[r],i={};return a.forEach(n=>n({phase:we.Stringify,buffer:t,context:i})),t[0]},lr=async(r,a,t,i,n)=>{typeof r=="object"&&!(r instanceof String)&&(r instanceof Promise||(r=r.toString()),r instanceof Promise&&(r=await r));const o=r.callbacks;if(!(o!=null&&o.length))return Promise.resolve(r);n?n[0]+=r:n=[r];const l=Promise.all(o.map(s=>s({phase:a,buffer:n,context:i}))).then(s=>Promise.all(s.filter(Boolean).map(c=>lr(c,a,!1,i,n))).then(()=>n[0]));return t?D(await l,o):l},_a=(r,...a)=>{const t=[""];for(let i=0,n=r.length-1;i<n;i++){t[0]+=r[i];const o=Array.isArray(a[i])?a[i].flat(1/0):[a[i]];for(let l=0,s=o.length;l<s;l++){const c=o[l];if(typeof c=="string")ae(c,t);else if(typeof c=="number")t[0]+=c;else{if(typeof c=="boolean"||c===null||c===void 0)continue;if(typeof c=="object"&&c.isEscaped)if(c.callbacks)t.unshift("",c);else{const d=c.toString();d instanceof Promise?t.unshift("",d):t[0]+=d}else c instanceof Promise?t.unshift("",c):ae(c.toString(),t)}}}return t[0]+=r.at(-1),t.length===1?"callbacks"in t?D(da(D(t[0],t.callbacks))):D(t[0]):ca(t,t.callbacks)},Rr=Symbol("RENDERER"),Ar=Symbol("ERROR_HANDLER"),I=Symbol("STASH"),pa=Symbol("INTERNAL"),Va=Symbol("MEMO"),sr=Symbol("PERMALINK"),Nr=r=>(r[pa]=!0,r),ha=r=>({value:a,children:t})=>{if(!t)return;const i={children:[{tag:Nr(()=>{r.push(a)}),props:{}}]};Array.isArray(t)?i.children.push(...t.flat()):i.children.push(t),i.children.push({tag:Nr(()=>{r.pop()}),props:{}});const n={tag:"",props:i,type:""};return n[Ar]=o=>{throw r.pop(),o},n},ga=r=>{const a=[r],t=ha(a);return t.values=a,t.Provider=t,Ie.push(t),t},Ie=[],Lr=r=>{const a=[r],t=(i=>{a.push(i.value);let n;try{n=i.children?(Array.isArray(i.children)?new xa("",{},i.children):i.children).toString():""}catch(o){throw a.pop(),o}return n instanceof Promise?n.finally(()=>a.pop()).then(o=>D(o,o.callbacks)):(a.pop(),D(n))});return t.values=a,t.Provider=t,t[Rr]=ha(a),Ie.push(t),t},Le=r=>r.values.at(-1),cr={title:[],script:["src"],style:["data-href"],link:["href"],meta:["name","httpEquiv","charset","itemProp"]},Sr={},oe="data-precedence",fa=r=>r.rel==="stylesheet"&&"precedence"in r,ua=(r,a)=>r==="link"?a:cr[r].length>0,Ve=r=>Array.isArray(r)?r:[r],Ur=new WeakMap,Gr=(r,a,t,i)=>({buffer:n,context:o})=>{if(!n)return;const l=Ur.get(o)||{};Ur.set(o,l);const s=l[r]||(l[r]=[]);let c=!1;const d=cr[r],h=ua(r,i!==void 0);if(h){e:for(const[,g]of s)if(!(r==="link"&&!(g.rel==="stylesheet"&&g[oe]!==void 0))){for(const f of d)if(((g==null?void 0:g[f])??null)===(t==null?void 0:t[f])){c=!0;break e}}}if(c?n[0]=n[0].replaceAll(a,""):h||r==="link"?s.push([a,t,i]):s.unshift([a,t,i]),n[0].indexOf("</head>")!==-1){let g;if(r==="link"||i!==void 0){const f=[];g=s.map(([u,,v],b)=>{if(v===void 0)return[u,Number.MAX_SAFE_INTEGER,b];let x=f.indexOf(v);return x===-1&&(f.push(v),x=f.length-1),[u,x,b]}).sort((u,v)=>u[1]-v[1]||u[2]-v[2]).map(([u])=>u)}else g=s.map(([f])=>f);g.forEach(f=>{n[0]=n[0].replaceAll(f,"")}),n[0]=n[0].replace(/(?=<\/head>)/,g.join(""))}},Ke=(r,a,t)=>D(new H(r,t,Ve(a??[])).toString()),We=(r,a,t,i)=>{if("itemProp"in t)return Ke(r,a,t);let{precedence:n,blocking:o,...l}=t;n=i?n??"":void 0,i&&(l[oe]=n);const s=new H(r,l,Ve(a||[])).toString();return s instanceof Promise?s.then(c=>D(s,[...c.callbacks||[],Gr(r,c,l,n)])):D(s,[Gr(r,s,l,n)])},Ka=({children:r,...a})=>{const t=Mr();if(t){const i=Le(t);if(i==="svg"||i==="head")return new H("title",a,Ve(r??[]))}return We("title",r,a,!1)},Wa=({children:r,...a})=>{const t=Mr();return["src","async"].some(i=>!a[i])||t&&Le(t)==="head"?Ke("script",r,a):We("script",r,a,!1)},Xa=({children:r,...a})=>["href","precedence"].every(t=>t in a)?(a["data-href"]=a.href,delete a.href,We("style",r,a,!0)):Ke("style",r,a),Za=({children:r,...a})=>["onLoad","onError"].some(t=>t in a)||a.rel==="stylesheet"&&(!("precedence"in a)||"disabled"in a)?Ke("link",r,a):We("link",r,a,fa(a)),Qa=({children:r,...a})=>{const t=Mr();return t&&Le(t)==="head"?Ke("meta",r,a):We("meta",r,a,!1)},va=(r,{children:a,...t})=>new H(r,t,Ve(a??[])),et=r=>(typeof r.action=="function"&&(r.action=sr in r.action?r.action[sr]:void 0),va("form",r)),ma=(r,a)=>(typeof a.formAction=="function"&&(a.formAction=sr in a.formAction?a.formAction[sr]:void 0),va(r,a)),rt=r=>ma("input",r),at=r=>ma("button",r);const vr=Object.freeze(Object.defineProperty({__proto__:null,button:at,form:et,input:rt,link:Za,meta:Qa,script:Wa,style:Xa,title:Ka},Symbol.toStringTag,{value:"Module"}));var tt=new Map([["className","class"],["htmlFor","for"],["crossOrigin","crossorigin"],["httpEquiv","http-equiv"],["itemProp","itemprop"],["fetchPriority","fetchpriority"],["noModule","nomodule"],["formAction","formaction"]]),dr=r=>tt.get(r)||r,ba=(r,a)=>{for(const[t,i]of Object.entries(r)){const n=t[0]==="-"||!/[A-Z]/.test(t)?t:t.replace(/[A-Z]/g,o=>`-${o.toLowerCase()}`);a(n,i==null?null:typeof i=="number"?n.match(/^(?:a|border-im|column(?:-c|s)|flex(?:$|-[^b])|grid-(?:ar|[^a])|font-w|li|or|sca|st|ta|wido|z)|ty$/)?`${i}`:`${i}px`:i)}},Ne=void 0,Mr=()=>Ne,it=r=>/[A-Z]/.test(r)&&r.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/)?r.replace(/([A-Z])/g,"-$1").toLowerCase():r,nt=["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],ot=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","inert","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected"],Or=(r,a)=>{for(let t=0,i=r.length;t<i;t++){const n=r[t];if(typeof n=="string")ae(n,a);else{if(typeof n=="boolean"||n===null||n===void 0)continue;n instanceof H?n.toStringToBuffer(a):typeof n=="number"||n.isEscaped?a[0]+=n:n instanceof Promise?a.unshift("",n):Or(n,a)}}},H=class{constructor(r,a,t){m(this,"tag");m(this,"props");m(this,"key");m(this,"children");m(this,"isEscaped",!0);m(this,"localContexts");this.tag=r,this.props=a,this.children=t}get type(){return this.tag}get ref(){return this.props.ref||null}toString(){var a,t;const r=[""];(a=this.localContexts)==null||a.forEach(([i,n])=>{i.values.push(n)});try{this.toStringToBuffer(r)}finally{(t=this.localContexts)==null||t.forEach(([i])=>{i.values.pop()})}return r.length===1?"callbacks"in r?da(D(r[0],r.callbacks)).toString():r[0]:ca(r,r.callbacks)}toStringToBuffer(r){const a=this.tag,t=this.props;let{children:i}=this;r[0]+=`<${a}`;const n=Ne&&Le(Ne)==="svg"?o=>it(dr(o)):o=>dr(o);for(let[o,l]of Object.entries(t))if(o=n(o),o!=="children"){if(o==="style"&&typeof l=="object"){let s="";ba(l,(c,d)=>{d!=null&&(s+=`${s?";":""}${c}:${d}`)}),r[0]+=' style="',ae(s,r),r[0]+='"'}else if(typeof l=="string")r[0]+=` ${o}="`,ae(l,r),r[0]+='"';else if(l!=null)if(typeof l=="number"||l.isEscaped)r[0]+=` ${o}="${l}"`;else if(typeof l=="boolean"&&ot.includes(o))l&&(r[0]+=` ${o}=""`);else if(o==="dangerouslySetInnerHTML"){if(i.length>0)throw new Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");i=[D(l.__html)]}else if(l instanceof Promise)r[0]+=` ${o}="`,r.unshift('"',l);else if(typeof l=="function"){if(!o.startsWith("on")&&o!=="ref")throw new Error(`Invalid prop '${o}' of type 'function' supplied to '${a}'.`)}else r[0]+=` ${o}="`,ae(l.toString(),r),r[0]+='"'}if(nt.includes(a)&&i.length===0){r[0]+="/>";return}r[0]+=">",Or(i,r),r[0]+=`</${a}>`}},mr=class extends H{toStringToBuffer(r){const{children:a}=this,t={...this.props};a.length&&(t.children=a.length===1?a[0]:a);const i=this.tag.call(null,t);if(!(typeof i=="boolean"||i==null))if(i instanceof Promise)if(Ie.length===0)r.unshift("",i);else{const n=Ie.map(o=>[o,o.values.at(-1)]);r.unshift("",i.then(o=>(o instanceof H&&(o.localContexts=n),o)))}else i instanceof H?i.toStringToBuffer(r):typeof i=="number"||i.isEscaped?(r[0]+=i,i.callbacks&&(r.callbacks||(r.callbacks=[]),r.callbacks.push(...i.callbacks))):ae(i,r)}},xa=class extends H{toStringToBuffer(r){Or(this.children,r)}},Fr=(r,a,...t)=>{a??(a={}),t.length&&(a.children=t.length===1?t[0]:t);const i=a.key;delete a.key;const n=rr(r,a,t);return n.key=i,n},Br=!1,rr=(r,a,t)=>{if(!Br){for(const i in Sr)vr[i][Rr]=Sr[i];Br=!0}return typeof r=="function"?new mr(r,a,t):vr[r]?new mr(vr[r],a,t):r==="svg"||r==="head"?(Ne||(Ne=Lr("")),new H(r,a,[new mr(Ne,{value:r},t)])):new H(r,a,t)},ge=({children:r})=>new xa("",{children:r},Array.isArray(r)?r:r?[r]:[]);function e(r,a,t){let i;if(!a||!("children"in a))i=rr(r,a,[]);else{const n=a.children;i=Array.isArray(n)?rr(r,a,n):rr(r,a,[n])}return i.key=t,i}var Jr=(r,a,t)=>(i,n)=>{let o=-1;return l(0);async function l(s){if(s<=o)throw new Error("next() called multiple times");o=s;let c,d=!1,h;if(r[s]?(h=r[s][0][0],i.req.routeIndex=s):h=s===r.length&&n||void 0,h)try{c=await h(i,()=>l(s+1))}catch(g){if(g instanceof Error&&a)i.error=g,c=await a(g,i),d=!0;else throw g}else i.finalized===!1&&t&&(c=await t(i));return c&&(i.finalized===!1||d)&&(i.res=c),i}},lt=Symbol(),st=async(r,a=Object.create(null))=>{const{all:t=!1,dot:i=!1}=a,o=(r instanceof Aa?r.raw.headers:r.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?ct(r,{all:t,dot:i}):{}};async function ct(r,a){const t=await r.formData();return t?dt(t,a):{}}function dt(r,a){const t=Object.create(null);return r.forEach((i,n)=>{a.all||n.endsWith("[]")?pt(t,n,i):t[n]=i}),a.dot&&Object.entries(t).forEach(([i,n])=>{i.includes(".")&&(ht(t,i,n),delete t[i])}),t}var pt=(r,a,t)=>{r[a]!==void 0?Array.isArray(r[a])?r[a].push(t):r[a]=[r[a],t]:a.endsWith("[]")?r[a]=[t]:r[a]=t},ht=(r,a,t)=>{if(/(?:^|\.)__proto__\./.test(a))return;let i=r;const n=a.split(".");n.forEach((o,l)=>{l===n.length-1?i[o]=t:((!i[o]||typeof i[o]!="object"||Array.isArray(i[o])||i[o]instanceof File)&&(i[o]=Object.create(null)),i=i[o])})},ya=r=>{const a=r.split("/");return a[0]===""&&a.shift(),a},gt=r=>{const{groups:a,path:t}=ft(r),i=ya(t);return ut(i,a)},ft=r=>{const a=[];return r=r.replace(/\{[^}]+\}/g,(t,i)=>{const n=`@${i}`;return a.push([n,t]),n}),{groups:a,path:r}},ut=(r,a)=>{for(let t=a.length-1;t>=0;t--){const[i]=a[t];for(let n=r.length-1;n>=0;n--)if(r[n].includes(i)){r[n]=r[n].replace(i,a[t][1]);break}}return r},Qe={},vt=(r,a)=>{if(r==="*")return"*";const t=r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(t){const i=`${r}#${a}`;return Qe[i]||(t[2]?Qe[i]=a&&a[0]!==":"&&a[0]!=="*"?[i,t[1],new RegExp(`^${t[2]}(?=/${a})`)]:[r,t[1],new RegExp(`^${t[2]}$`)]:Qe[i]=[r,t[1],!0]),Qe[i]}return null},Tr=(r,a)=>{try{return a(r)}catch{return r.replace(/(?:%[0-9A-Fa-f]{2})+/g,t=>{try{return a(t)}catch{return t}})}},mt=r=>Tr(r,decodeURI),wa=r=>{const a=r.url,t=a.indexOf("/",a.indexOf(":")+4);let i=t;for(;i<a.length;i++){const n=a.charCodeAt(i);if(n===37){const o=a.indexOf("?",i),l=a.indexOf("#",i),s=o===-1?l===-1?void 0:l:l===-1?o:Math.min(o,l),c=a.slice(t,s);return mt(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(n===63||n===35)break}return a.slice(t,i)},bt=r=>{const a=wa(r);return a.length>1&&a.at(-1)==="/"?a.slice(0,-1):a},be=(r,a,...t)=>(t.length&&(a=be(a,...t)),`${(r==null?void 0:r[0])==="/"?"":"/"}${r}${a==="/"?"":`${(r==null?void 0:r.at(-1))==="/"?"":"/"}${(a==null?void 0:a[0])==="/"?a.slice(1):a}`}`),ka=r=>{if(r.charCodeAt(r.length-1)!==63||!r.includes(":"))return null;const a=r.split("/"),t=[];let i="";return a.forEach(n=>{if(n!==""&&!/\:/.test(n))i+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){t.length===0&&i===""?t.push("/"):t.push(i);const o=n.replace("?","");i+="/"+o,t.push(i)}else i+="/"+n}),t.filter((n,o,l)=>l.indexOf(n)===o)},br=r=>/[%+]/.test(r)?(r.indexOf("+")!==-1&&(r=r.replace(/\+/g," ")),r.indexOf("%")!==-1?Tr(r,Ea):r):r,qa=(r,a,t)=>{let i;if(!t&&a&&!/[%+]/.test(a)){let l=r.indexOf("?",8);if(l===-1)return;for(r.startsWith(a,l+1)||(l=r.indexOf(`&${a}`,l+1));l!==-1;){const s=r.charCodeAt(l+a.length+1);if(s===61){const c=l+a.length+2,d=r.indexOf("&",c);return br(r.slice(c,d===-1?void 0:d))}else if(s==38||isNaN(s))return"";l=r.indexOf(`&${a}`,l+1)}if(i=/[%+]/.test(r),!i)return}const n={};i??(i=/[%+]/.test(r));let o=r.indexOf("?",8);for(;o!==-1;){const l=r.indexOf("&",o+1);let s=r.indexOf("=",o);s>l&&l!==-1&&(s=-1);let c=r.slice(o+1,s===-1?l===-1?void 0:l:s);if(i&&(c=br(c)),o=l,c==="")continue;let d;s===-1?d="":(d=r.slice(s+1,l===-1?void 0:l),i&&(d=br(d))),t?(n[c]&&Array.isArray(n[c])||(n[c]=[]),n[c].push(d)):n[c]??(n[c]=d)}return a?n[a]:n},xt=qa,yt=(r,a)=>qa(r,a,!0),Ea=decodeURIComponent,Yr=r=>Tr(r,Ea),ke,j,K,Sa,Ca,Cr,W,ta,Aa=(ta=class{constructor(r,a="/",t=[[]]){w(this,K);m(this,"raw");w(this,ke);w(this,j);m(this,"routeIndex",0);m(this,"path");m(this,"bodyCache",{});w(this,W,r=>{const{bodyCache:a,raw:t}=this,i=a[r];if(i)return i;const n=Object.keys(a)[0];return n?a[n].then(o=>(n==="json"&&(o=JSON.stringify(o)),new Response(o)[r]())):a[r]=t[r]()});this.raw=r,this.path=a,y(this,j,t),y(this,ke,{})}param(r){return r?A(this,K,Sa).call(this,r):A(this,K,Ca).call(this)}query(r){return xt(this.url,r)}queries(r){return yt(this.url,r)}header(r){if(r)return this.raw.headers.get(r)??void 0;const a={};return this.raw.headers.forEach((t,i)=>{a[i]=t}),a}async parseBody(r){var a;return(a=this.bodyCache).parsedBody??(a.parsedBody=await st(this,r))}json(){return p(this,W).call(this,"text").then(r=>JSON.parse(r))}text(){return p(this,W).call(this,"text")}arrayBuffer(){return p(this,W).call(this,"arrayBuffer")}blob(){return p(this,W).call(this,"blob")}formData(){return p(this,W).call(this,"formData")}addValidatedData(r,a){p(this,ke)[r]=a}valid(r){return p(this,ke)[r]}get url(){return this.raw.url}get method(){return this.raw.method}get[lt](){return p(this,j)}get matchedRoutes(){return p(this,j)[0].map(([[,r]])=>r)}get routePath(){return p(this,j)[0].map(([[,r]])=>r)[this.routeIndex].path}},ke=new WeakMap,j=new WeakMap,K=new WeakSet,Sa=function(r){const a=p(this,j)[0][this.routeIndex][1][r],t=A(this,K,Cr).call(this,a);return t&&/\%/.test(t)?Yr(t):t},Ca=function(){const r={},a=Object.keys(p(this,j)[0][this.routeIndex][1]);for(const t of a){const i=A(this,K,Cr).call(this,p(this,j)[0][this.routeIndex][1][t]);i!==void 0&&(r[t]=/\%/.test(i)?Yr(i):i)}return r},Cr=function(r){return p(this,j)[1]?p(this,j)[1][r]:r},W=new WeakMap,ta),wt="text/plain; charset=UTF-8",xr=(r,a)=>({"Content-Type":r,...a}),Te=(r,a)=>new Response(r,a),Fe,Be,Y,qe,$,P,Je,Ee,Ae,le,Ye,$e,X,xe,ia,kt=(ia=class{constructor(r,a){w(this,X);w(this,Fe);w(this,Be);m(this,"env",{});w(this,Y);m(this,"finalized",!1);m(this,"error");w(this,qe);w(this,$);w(this,P);w(this,Je);w(this,Ee);w(this,Ae);w(this,le);w(this,Ye);w(this,$e);m(this,"render",(...r)=>(p(this,Ee)??y(this,Ee,a=>this.html(a)),p(this,Ee).call(this,...r)));m(this,"setLayout",r=>y(this,Je,r));m(this,"getLayout",()=>p(this,Je));m(this,"setRenderer",r=>{y(this,Ee,r)});m(this,"header",(r,a,t)=>{this.finalized&&y(this,P,Te(p(this,P).body,p(this,P)));const i=p(this,P)?p(this,P).headers:p(this,le)??y(this,le,new Headers);a===void 0?i.delete(r):t!=null&&t.append?i.append(r,a):i.set(r,a)});m(this,"status",r=>{y(this,qe,r)});m(this,"set",(r,a)=>{p(this,Y)??y(this,Y,new Map),p(this,Y).set(r,a)});m(this,"get",r=>p(this,Y)?p(this,Y).get(r):void 0);m(this,"newResponse",(...r)=>A(this,X,xe).call(this,...r));m(this,"body",(r,a,t)=>A(this,X,xe).call(this,r,a,t));m(this,"text",(r,a,t)=>!p(this,le)&&!p(this,qe)&&!a&&!t&&!this.finalized?new Response(r):A(this,X,xe).call(this,r,a,xr(wt,t)));m(this,"json",(r,a,t)=>A(this,X,xe).call(this,JSON.stringify(r),a,xr("application/json",t)));m(this,"html",(r,a,t)=>{const i=n=>A(this,X,xe).call(this,n,a,xr("text/html; charset=UTF-8",t));return typeof r=="object"?lr(r,we.Stringify,!1,{}).then(i):i(r)});m(this,"redirect",(r,a)=>{const t=String(r);return this.header("Location",/[^\x00-\xFF]/.test(t)?encodeURI(t):t),this.newResponse(null,a??302)});m(this,"notFound",()=>(p(this,Ae)??y(this,Ae,()=>Te()),p(this,Ae).call(this,this)));y(this,Fe,r),a&&(y(this,$,a.executionCtx),this.env=a.env,y(this,Ae,a.notFoundHandler),y(this,$e,a.path),y(this,Ye,a.matchResult))}get req(){return p(this,Be)??y(this,Be,new Aa(p(this,Fe),p(this,$e),p(this,Ye))),p(this,Be)}get event(){if(p(this,$)&&"respondWith"in p(this,$))return p(this,$);throw Error("This context has no FetchEvent")}get executionCtx(){if(p(this,$))return p(this,$);throw Error("This context has no ExecutionContext")}get res(){return p(this,P)||y(this,P,Te(null,{headers:p(this,le)??y(this,le,new Headers)}))}set res(r){if(p(this,P)&&r){r=Te(r.body,r);for(const[a,t]of p(this,P).headers.entries())if(a!=="content-type")if(a==="set-cookie"){const i=p(this,P).headers.getSetCookie();r.headers.delete("set-cookie");for(const n of i)r.headers.append("set-cookie",n)}else r.headers.set(a,t)}y(this,P,r),this.finalized=!0}get var(){return p(this,Y)?Object.fromEntries(p(this,Y)):{}}},Fe=new WeakMap,Be=new WeakMap,Y=new WeakMap,qe=new WeakMap,$=new WeakMap,P=new WeakMap,Je=new WeakMap,Ee=new WeakMap,Ae=new WeakMap,le=new WeakMap,Ye=new WeakMap,$e=new WeakMap,X=new WeakSet,xe=function(r,a,t){const i=p(this,P)?new Headers(p(this,P).headers):p(this,le)??new Headers;if(typeof a=="object"&&"headers"in a){const o=a.headers instanceof Headers?a.headers:new Headers(a.headers);for(const[l,s]of o)l.toLowerCase()==="set-cookie"?i.append(l,s):i.set(l,s)}if(t)for(const[o,l]of Object.entries(t))if(typeof l=="string")i.set(o,l);else{i.delete(o);for(const s of l)i.append(o,s)}const n=typeof a=="number"?a:(a==null?void 0:a.status)??p(this,qe);return Te(r,{status:n,headers:i})},ia),R="ALL",qt="all",Et=["get","post","put","delete","options","patch"],za="Can not add a route since the matcher is already built.",Ia=class extends Error{},At="__COMPOSED_HANDLER",St=r=>r.text("404 Not Found",404),$r=(r,a)=>{if("getResponse"in r){const t=r.getResponse();return a.newResponse(t.body,t)}return console.error(r),a.text("Internal Server Error",500)},N,L,Ra,U,ie,ar,tr,Se,Ct=(Se=class{constructor(a={}){w(this,L);m(this,"get");m(this,"post");m(this,"put");m(this,"delete");m(this,"options");m(this,"patch");m(this,"all");m(this,"on");m(this,"use");m(this,"router");m(this,"getPath");m(this,"_basePath","/");w(this,N,"/");m(this,"routes",[]);w(this,U,St);m(this,"errorHandler",$r);m(this,"onError",a=>(this.errorHandler=a,this));m(this,"notFound",a=>(y(this,U,a),this));m(this,"fetch",(a,...t)=>A(this,L,tr).call(this,a,t[1],t[0],a.method));m(this,"request",(a,t,i,n)=>a instanceof Request?this.fetch(t?new Request(a,t):a,i,n):(a=a.toString(),this.fetch(new Request(/^https?:\/\//.test(a)?a:`http://localhost${be("/",a)}`,t),i,n)));m(this,"fire",()=>{addEventListener("fetch",a=>{a.respondWith(A(this,L,tr).call(this,a.request,a,void 0,a.request.method))})});[...Et,qt].forEach(o=>{this[o]=(l,...s)=>(typeof l=="string"?y(this,N,l):A(this,L,ie).call(this,o,p(this,N),l),s.forEach(c=>{A(this,L,ie).call(this,o,p(this,N),c)}),this)}),this.on=(o,l,...s)=>{for(const c of[l].flat()){y(this,N,c);for(const d of[o].flat())s.map(h=>{A(this,L,ie).call(this,d.toUpperCase(),p(this,N),h)})}return this},this.use=(o,...l)=>(typeof o=="string"?y(this,N,o):(y(this,N,"*"),l.unshift(o)),l.forEach(s=>{A(this,L,ie).call(this,R,p(this,N),s)}),this);const{strict:i,...n}=a;Object.assign(this,n),this.getPath=i??!0?a.getPath??wa:bt}route(a,t){const i=this.basePath(a);return t.routes.map(n=>{var l;let o;t.errorHandler===$r?o=n.handler:(o=async(s,c)=>(await Jr([],t.errorHandler)(s,()=>n.handler(s,c))).res,o[At]=n.handler),A(l=i,L,ie).call(l,n.method,n.path,o)}),this}basePath(a){const t=A(this,L,Ra).call(this);return t._basePath=be(this._basePath,a),t}mount(a,t,i){let n,o;i&&(typeof i=="function"?o=i:(o=i.optionHandler,i.replaceRequest===!1?n=c=>c:n=i.replaceRequest));const l=o?c=>{const d=o(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};n||(n=(()=>{const c=be(this._basePath,a),d=c==="/"?0:c.length;return h=>{const g=new URL(h.url);return g.pathname=g.pathname.slice(d)||"/",new Request(g,h)}})());const s=async(c,d)=>{const h=await t(n(c.req.raw),...l(c));if(h)return h;await d()};return A(this,L,ie).call(this,R,be(a,"*"),s),this}},N=new WeakMap,L=new WeakSet,Ra=function(){const a=new Se({router:this.router,getPath:this.getPath});return a.errorHandler=this.errorHandler,y(a,U,p(this,U)),a.routes=this.routes,a},U=new WeakMap,ie=function(a,t,i){a=a.toUpperCase(),t=be(this._basePath,t);const n={basePath:this._basePath,path:t,method:a,handler:i};this.router.add(a,t,[i,n]),this.routes.push(n)},ar=function(a,t){if(a instanceof Error)return this.errorHandler(a,t);throw a},tr=function(a,t,i,n){if(n==="HEAD")return(async()=>new Response(null,await A(this,L,tr).call(this,a,t,i,"GET")))();const o=this.getPath(a,{env:i}),l=this.router.match(n,o),s=new kt(a,{path:o,matchResult:l,env:i,executionCtx:t,notFoundHandler:p(this,U)});if(l[0].length===1){let d;try{d=l[0][0][0][0](s,async()=>{s.res=await p(this,U).call(this,s)})}catch(h){return A(this,L,ar).call(this,h,s)}return d instanceof Promise?d.then(h=>h||(s.finalized?s.res:p(this,U).call(this,s))).catch(h=>A(this,L,ar).call(this,h,s)):d??p(this,U).call(this,s)}const c=Jr(l[0],this.errorHandler,p(this,U));return(async()=>{try{const d=await c(s);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return A(this,L,ar).call(this,d,s)}})()},Se),La=[];function zt(r,a){const t=this.buildAllMatchers(),i=((n,o)=>{const l=t[n]||t[R],s=l[2][o];if(s)return s;const c=o.match(l[0]);if(!c)return[[],La];const d=c.indexOf("",1);return[l[1][d],c]});return this.match=i,i(r,a)}var pr="[^/]+",je=".*",He="(?:|/.*)",ye=Symbol(),It=new Set(".\\+*[^]$()");function Rt(r,a){return r.length===1?a.length===1?r<a?-1:1:-1:a.length===1||r===je||r===He?1:a===je||a===He?-1:r===pr?1:a===pr?-1:r.length===a.length?r<a?-1:1:a.length-r.length}var se,ce,G,he,Lt=(he=class{constructor(){w(this,se);w(this,ce);w(this,G,Object.create(null))}insert(a,t,i,n,o){if(a.length===0){if(p(this,se)!==void 0)throw ye;if(o)return;y(this,se,t);return}const[l,...s]=a,c=l==="*"?s.length===0?["","",je]:["","",pr]:l==="/*"?["","",He]:l.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const h=c[1];let g=c[2]||pr;if(h&&c[2]&&(g===".*"||(g=g.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(g))))throw ye;if(d=p(this,G)[g],!d){if(Object.keys(p(this,G)).some(f=>f!==je&&f!==He))throw ye;if(o)return;d=p(this,G)[g]=new he,h!==""&&y(d,ce,n.varIndex++)}!o&&h!==""&&i.push([h,p(d,ce)])}else if(d=p(this,G)[l],!d){if(Object.keys(p(this,G)).some(h=>h.length>1&&h!==je&&h!==He))throw ye;if(o)return;d=p(this,G)[l]=new he}d.insert(s,t,i,n,o)}buildRegExpStr(){const t=Object.keys(p(this,G)).sort(Rt).map(i=>{const n=p(this,G)[i];return(typeof p(n,ce)=="number"?`(${i})@${p(n,ce)}`:It.has(i)?`\\${i}`:i)+n.buildRegExpStr()});return typeof p(this,se)=="number"&&t.unshift(`#${p(this,se)}`),t.length===0?"":t.length===1?t[0]:"(?:"+t.join("|")+")"}},se=new WeakMap,ce=new WeakMap,G=new WeakMap,he),hr,_e,na,Mt=(na=class{constructor(){w(this,hr,{varIndex:0});w(this,_e,new Lt)}insert(r,a,t){const i=[],n=[];for(let l=0;;){let s=!1;if(r=r.replace(/\{[^}]+\}/g,c=>{const d=`@\\${l}`;return n[l]=[d,c],l++,s=!0,d}),!s)break}const o=r.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let l=n.length-1;l>=0;l--){const[s]=n[l];for(let c=o.length-1;c>=0;c--)if(o[c].indexOf(s)!==-1){o[c]=o[c].replace(s,n[l][1]);break}}return p(this,_e).insert(o,a,i,p(this,hr),t),i}buildRegExp(){let r=p(this,_e).buildRegExpStr();if(r==="")return[/^$/,[],[]];let a=0;const t=[],i=[];return r=r.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,o,l)=>o!==void 0?(t[++a]=Number(o),"$()"):(l!==void 0&&(i[Number(l)]=++a),"")),[new RegExp(`^${r}`),t,i]}},hr=new WeakMap,_e=new WeakMap,na),Ot=[/^$/,[],Object.create(null)],ir=Object.create(null);function Ma(r){return ir[r]??(ir[r]=new RegExp(r==="*"?"":`^${r.replace(/\/\*$|([.\\+*[^\]$()])/g,(a,t)=>t?`\\${t}`:"(?:|/.*)")}$`))}function Tt(){ir=Object.create(null)}function Pt(r){var d;const a=new Mt,t=[];if(r.length===0)return Ot;const i=r.map(h=>[!/\*|\/:/.test(h[0]),...h]).sort(([h,g],[f,u])=>h?1:f?-1:g.length-u.length),n=Object.create(null);for(let h=0,g=-1,f=i.length;h<f;h++){const[u,v,b]=i[h];u?n[v]=[b.map(([q])=>[q,Object.create(null)]),La]:g++;let x;try{x=a.insert(v,g,u)}catch(q){throw q===ye?new Ia(v):q}u||(t[g]=b.map(([q,k])=>{const O=Object.create(null);for(k-=1;k>=0;k--){const[E,C]=x[k];O[E]=C}return[q,O]}))}const[o,l,s]=a.buildRegExp();for(let h=0,g=t.length;h<g;h++)for(let f=0,u=t[h].length;f<u;f++){const v=(d=t[h][f])==null?void 0:d[1];if(!v)continue;const b=Object.keys(v);for(let x=0,q=b.length;x<q;x++)v[b[x]]=s[v[b[x]]]}const c=[];for(const h in l)c[h]=t[l[h]];return[o,c,n]}function ve(r,a){if(r){for(const t of Object.keys(r).sort((i,n)=>n.length-i.length))if(Ma(t).test(a))return[...r[t]]}}var Z,Q,gr,Oa,oa,Dt=(oa=class{constructor(){w(this,gr);m(this,"name","RegExpRouter");w(this,Z);w(this,Q);m(this,"match",zt);y(this,Z,{[R]:Object.create(null)}),y(this,Q,{[R]:Object.create(null)})}add(r,a,t){var s;const i=p(this,Z),n=p(this,Q);if(!i||!n)throw new Error(za);i[r]||[i,n].forEach(c=>{c[r]=Object.create(null),Object.keys(c[R]).forEach(d=>{c[r][d]=[...c[R][d]]})}),a==="/*"&&(a="*");const o=(a.match(/\/:/g)||[]).length;if(/\*$/.test(a)){const c=Ma(a);r===R?Object.keys(i).forEach(d=>{var h;(h=i[d])[a]||(h[a]=ve(i[d],a)||ve(i[R],a)||[])}):(s=i[r])[a]||(s[a]=ve(i[r],a)||ve(i[R],a)||[]),Object.keys(i).forEach(d=>{(r===R||r===d)&&Object.keys(i[d]).forEach(h=>{c.test(h)&&i[d][h].push([t,o])})}),Object.keys(n).forEach(d=>{(r===R||r===d)&&Object.keys(n[d]).forEach(h=>c.test(h)&&n[d][h].push([t,o]))});return}const l=ka(a)||[a];for(let c=0,d=l.length;c<d;c++){const h=l[c];Object.keys(n).forEach(g=>{var f;(r===R||r===g)&&((f=n[g])[h]||(f[h]=[...ve(i[g],h)||ve(i[R],h)||[]]),n[g][h].push([t,o-d+c+1]))})}}buildAllMatchers(){const r=Object.create(null);return Object.keys(p(this,Q)).concat(Object.keys(p(this,Z))).forEach(a=>{r[a]||(r[a]=A(this,gr,Oa).call(this,a))}),y(this,Z,y(this,Q,void 0)),Tt(),r}},Z=new WeakMap,Q=new WeakMap,gr=new WeakSet,Oa=function(r){const a=[];let t=r===R;return[p(this,Z),p(this,Q)].forEach(i=>{const n=i[r]?Object.keys(i[r]).map(o=>[o,i[r][o]]):[];n.length!==0?(t||(t=!0),a.push(...n)):r!==R&&a.push(...Object.keys(i[R]).map(o=>[o,i[R][o]]))}),t?Pt(a):null},oa),ee,_,la,jt=(la=class{constructor(r){m(this,"name","SmartRouter");w(this,ee,[]);w(this,_,[]);y(this,ee,r.routers)}add(r,a,t){if(!p(this,_))throw new Error(za);p(this,_).push([r,a,t])}match(r,a){if(!p(this,_))throw new Error("Fatal error");const t=p(this,ee),i=p(this,_),n=t.length;let o=0,l;for(;o<n;o++){const s=t[o];try{for(let c=0,d=i.length;c<d;c++)s.add(...i[c]);l=s.match(r,a)}catch(c){if(c instanceof Ia)continue;throw c}this.match=s.match.bind(s),y(this,ee,[s]),y(this,_,void 0);break}if(o===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,l}get activeRouter(){if(p(this,_)||p(this,ee).length!==1)throw new Error("No active router has been determined yet.");return p(this,ee)[0]}},ee=new WeakMap,_=new WeakMap,la),Pe=Object.create(null),Ht=r=>{for(const a in r)return!0;return!1},re,T,de,Ce,M,V,ne,ze,Nt=(ze=class{constructor(a,t,i){w(this,V);w(this,re);w(this,T);w(this,de);w(this,Ce,0);w(this,M,Pe);if(y(this,T,i||Object.create(null)),y(this,re,[]),a&&t){const n=Object.create(null);n[a]={handler:t,possibleKeys:[],score:0},y(this,re,[n])}y(this,de,[])}insert(a,t,i){y(this,Ce,++Hr(this,Ce)._);let n=this;const o=gt(t),l=[];for(let s=0,c=o.length;s<c;s++){const d=o[s],h=o[s+1],g=vt(d,h),f=Array.isArray(g)?g[0]:d;if(f in p(n,T)){n=p(n,T)[f],g&&l.push(g[1]);continue}p(n,T)[f]=new ze,g&&(p(n,de).push(g),l.push(g[1])),n=p(n,T)[f]}return p(n,re).push({[a]:{handler:i,possibleKeys:l.filter((s,c,d)=>d.indexOf(s)===c),score:p(this,Ce)}}),n}search(a,t){var h;const i=[];y(this,M,Pe);let o=[this];const l=ya(t),s=[],c=l.length;let d=null;for(let g=0;g<c;g++){const f=l[g],u=g===c-1,v=[];for(let x=0,q=o.length;x<q;x++){const k=o[x],O=p(k,T)[f];O&&(y(O,M,p(k,M)),u?(p(O,T)["*"]&&A(this,V,ne).call(this,i,p(O,T)["*"],a,p(k,M)),A(this,V,ne).call(this,i,O,a,p(k,M))):v.push(O));for(let E=0,C=p(k,de).length;E<C;E++){const S=p(k,de)[E],z=p(k,M)===Pe?{}:{...p(k,M)};if(S==="*"){const fe=p(k,T)["*"];fe&&(A(this,V,ne).call(this,i,fe,a,p(k,M)),y(fe,M,z),v.push(fe));continue}const[F,Ze,Me]=S;if(!f&&!(Me instanceof RegExp))continue;const B=p(k,T)[F];if(Me instanceof RegExp){if(d===null){d=new Array(c);let ue=t[0]==="/"?1:0;for(let Oe=0;Oe<c;Oe++)d[Oe]=ue,ue+=l[Oe].length+1}const fe=t.substring(d[g]),fr=Me.exec(fe);if(fr){if(z[Ze]=fr[0],A(this,V,ne).call(this,i,B,a,p(k,M),z),Ht(p(B,T))){y(B,M,z);const ue=((h=fr[0].match(/\//))==null?void 0:h.length)??0;(s[ue]||(s[ue]=[])).push(B)}continue}}(Me===!0||Me.test(f))&&(z[Ze]=f,u?(A(this,V,ne).call(this,i,B,a,z,p(k,M)),p(B,T)["*"]&&A(this,V,ne).call(this,i,p(B,T)["*"],a,z,p(k,M))):(y(B,M,z),v.push(B)))}}const b=s.shift();o=b?v.concat(b):v}return i.length>1&&i.sort((g,f)=>g.score-f.score),[i.map(({handler:g,params:f})=>[g,f])]}},re=new WeakMap,T=new WeakMap,de=new WeakMap,Ce=new WeakMap,M=new WeakMap,V=new WeakSet,ne=function(a,t,i,n,o){for(let l=0,s=p(t,re).length;l<s;l++){const c=p(t,re)[l],d=c[i]||c[R],h={};if(d!==void 0&&(d.params=Object.create(null),a.push(d),n!==Pe||o&&o!==Pe))for(let g=0,f=d.possibleKeys.length;g<f;g++){const u=d.possibleKeys[g],v=h[d.score];d.params[u]=o!=null&&o[u]&&!v?o[u]:n[u]??(o==null?void 0:o[u]),h[d.score]=!0}}},ze),pe,sa,Ut=(sa=class{constructor(){m(this,"name","TrieRouter");w(this,pe);y(this,pe,new Nt)}add(r,a,t){const i=ka(a);if(i){for(let n=0,o=i.length;n<o;n++)p(this,pe).insert(r,i[n],t);return}p(this,pe).insert(r,a,t)}match(r,a){return p(this,pe).search(r,a)}},pe=new WeakMap,sa),Ta=class extends Ct{constructor(r={}){super(r),this.router=r.router??new jt({routers:[new Dt,new Ut]})}},Ue="_hp",Gt={Change:"Input",DoubleClick:"DblClick"},Ft={svg:"2000/svg",math:"1998/Math/MathML"},Ge=[],zr=new WeakMap,Re=void 0,Bt=()=>Re,J=r=>"t"in r,yr={onClick:["click",!1]},_r=r=>{if(!r.startsWith("on"))return;if(yr[r])return yr[r];const a=r.match(/^on([A-Z][a-zA-Z]+?(?:PointerCapture)?)(Capture)?$/);if(a){const[,t,i]=a;return yr[r]=[(Gt[t]||t).toLowerCase(),!!i]}},Vr=(r,a)=>Re&&r instanceof SVGElement&&/[A-Z]/.test(a)&&(a in r.style||a.match(/^(?:o|pai|str|u|ve)/))?a.replace(/([A-Z])/g,"-$1").toLowerCase():a,Jt=(r,a,t)=>{var i;a||(a={});for(let n in a){const o=a[n];if(n!=="children"&&(!t||t[n]!==o)){n=dr(n);const l=_r(n);if(l){if((t==null?void 0:t[n])!==o&&(t&&r.removeEventListener(l[0],t[n],l[1]),o!=null)){if(typeof o!="function")throw new Error(`Event handler for "${n}" is not a function`);r.addEventListener(l[0],o,l[1])}}else if(n==="dangerouslySetInnerHTML"&&o)r.innerHTML=o.__html;else if(n==="ref"){let s;typeof o=="function"?s=o(r)||(()=>o(null)):o&&"current"in o&&(o.current=r,s=()=>o.current=null),zr.set(r,s)}else if(n==="style"){const s=r.style;typeof o=="string"?s.cssText=o:(s.cssText="",o!=null&&ba(o,s.setProperty.bind(s)))}else{if(n==="value"){const c=r.nodeName;if(c==="INPUT"||c==="TEXTAREA"||c==="SELECT"){if(r.value=o==null||o===!1?null:o,c==="TEXTAREA"){r.textContent=o;continue}else if(c==="SELECT"){r.selectedIndex===-1&&(r.selectedIndex=0);continue}}}else(n==="checked"&&r.nodeName==="INPUT"||n==="selected"&&r.nodeName==="OPTION")&&(r[n]=o);const s=Vr(r,n);o==null||o===!1?r.removeAttribute(s):o===!0?r.setAttribute(s,""):typeof o=="string"||typeof o=="number"?r.setAttribute(s,o):r.setAttribute(s,o.toString())}}}if(t)for(let n in t){const o=t[n];if(n!=="children"&&!(n in a)){n=dr(n);const l=_r(n);l?r.removeEventListener(l[0],o,l[1]):n==="ref"?(i=zr.get(r))==null||i():r.removeAttribute(Vr(r,n))}}},Yt=(r,a)=>{a[I][0]=0,Ge.push([r,a]);const t=a.tag[Rr]||a.tag,i=t.defaultProps?{...t.defaultProps,...a.props}:a.props;try{return[t.call(null,i)]}finally{Ge.pop()}},Pa=(r,a,t,i,n)=>{var o,l;(o=r.vR)!=null&&o.length&&(i.push(...r.vR),delete r.vR),typeof r.tag=="function"&&((l=r[I][1][Na])==null||l.forEach(s=>n.push(s))),r.vC.forEach(s=>{var c;if(J(s))t.push(s);else if(typeof s.tag=="function"||s.tag===""){s.c=a;const d=t.length;if(Pa(s,a,t,i,n),s.s){for(let h=d;h<t.length;h++)t[h].s=!0;s.s=!1}}else t.push(s),(c=s.vR)!=null&&c.length&&(i.push(...s.vR),delete s.vR)})},$t=r=>{var a;for(;r&&(r.tag===Ue||!r.e);)r=r.tag===Ue||!((a=r.vC)!=null&&a[0])?r.nN:r.vC[0];return r==null?void 0:r.e},Da=r=>{var a,t,i,n,o,l;J(r)||((t=(a=r[I])==null?void 0:a[1][Na])==null||t.forEach(s=>{var c;return(c=s[2])==null?void 0:c.call(s)}),(i=zr.get(r.e))==null||i(),r.p===2&&((n=r.vC)==null||n.forEach(s=>s.p=2)),(o=r.vC)==null||o.forEach(Da)),r.p||((l=r.e)==null||l.remove(),delete r.e),typeof r.tag=="function"&&(De.delete(r),nr.delete(r),delete r[I][3],r.a=!0)},ja=(r,a,t)=>{r.c=a,Ha(r,a,t)},Kr=(r,a)=>{if(a){for(let t=0,i=r.length;t<i;t++)if(r[t]===a)return t}},Wr=Symbol(),Ha=(r,a,t)=>{var d;const i=[],n=[],o=[];Pa(r,a,i,n,o),n.forEach(Da);const l=t?void 0:a.childNodes;let s,c=null;if(t)s=-1;else if(!l.length)s=0;else{const h=Kr(l,$t(r.nN));h!==void 0?(c=l[h],s=h):s=Kr(l,(d=i.find(g=>g.tag!==Ue&&g.e))==null?void 0:d.e)??-1,s===-1&&(t=!0)}for(let h=0,g=i.length;h<g;h++,s++){const f=i[h];let u;if(f.s&&f.e)u=f.e,f.s=!1;else{const v=t||!f.e;J(f)?(f.e&&f.d&&(f.e.textContent=f.t),f.d=!1,u=f.e||(f.e=document.createTextNode(f.t))):(u=f.e||(f.e=f.n?document.createElementNS(f.n,f.tag):document.createElement(f.tag)),Jt(u,f.props,f.pP),Ha(f,u,v))}f.tag===Ue?s--:t?u.parentNode||a.appendChild(u):l[s]!==u&&l[s-1]!==u&&(l[s+1]===u?a.appendChild(l[s]):a.insertBefore(u,c||l[s]||null))}if(r.pP&&(r.pP=void 0),o.length){const h=[],g=[];o.forEach(([,f,,u,v])=>{f&&h.push(f),u&&g.push(u),v==null||v()}),h.forEach(f=>f()),g.length&&requestAnimationFrame(()=>{g.forEach(f=>f())})}},_t=(r,a)=>!!(r&&r.length===a.length&&r.every((t,i)=>t[1]===a[i][1])),nr=new WeakMap,Ir=(r,a,t)=>{var o,l,s,c,d,h;const i=!t&&a.pC;t&&(a.pC||(a.pC=a.vC));let n;try{t||(t=typeof a.tag=="function"?Yt(r,a):Ve(a.props.children)),((o=t[0])==null?void 0:o.tag)===""&&t[0][Ar]&&(n=t[0][Ar],r[5].push([r,n,a]));const g=i?[...a.pC]:a.vC?[...a.vC]:void 0,f=[];let u;for(let v=0;v<t.length;v++){if(Array.isArray(t[v])){t.splice(v,1,...t[v].flat(1/0)),v--;continue}let b=Vt(t[v]);if(b){typeof b.tag=="function"&&!b.tag[pa]&&(Ie.length>0&&(b[I][2]=Ie.map(q=>[q,q.values.at(-1)])),(l=r[5])!=null&&l.length&&(b[I][3]=r[5].at(-1)));let x;if(g&&g.length){const q=g.findIndex(J(b)?k=>J(k):b.key!==void 0?k=>k.key===b.key&&k.tag===b.tag:k=>k.tag===b.tag);q!==-1&&(x=g[q],g.splice(q,1))}if(x)if(J(b))x.t!==b.t&&(x.t=b.t,x.d=!0),b=x;else{const q=x.pP=x.props;if(x.props=b.props,x.f||(x.f=b.f||a.f),typeof b.tag=="function"){const k=x[I][2];x[I][2]=b[I][2]||[],x[I][3]=b[I][3],!x.f&&((x.o||x)===b.o||(c=(s=x.tag)[Va])!=null&&c.call(s,q,x.props))&&_t(k,x[I][2])&&(x.s=!0)}b=x}else if(!J(b)&&Re){const q=Le(Re);q&&(b.n=q)}if(!J(b)&&!b.s&&(Ir(r,b),delete b.f),f.push(b),u&&!u.s&&!b.s)for(let q=u;q&&!J(q);q=(d=q.vC)==null?void 0:d.at(-1))q.nN=b;u=b}}a.vR=i?[...a.vC,...g||[]]:g||[],a.vC=f,i&&delete a.pC}catch(g){if(a.f=!0,g===Wr){if(n)return;throw g}const[f,u,v]=((h=a[I])==null?void 0:h[3])||[];if(u){const b=()=>or([0,!1,r[2]],v),x=nr.get(v)||[];x.push(b),nr.set(v,x);const q=u(g,()=>{const k=nr.get(v);if(k){const O=k.indexOf(b);if(O!==-1)return k.splice(O,1),b()}});if(q){if(r[0]===1)r[1]=!0;else if(Ir(r,v,[q]),(u.length===1||r!==f)&&v.c){ja(v,v.c,!1);return}throw Wr}}throw g}finally{n&&r[5].pop()}},Vt=r=>{if(!(r==null||typeof r=="boolean")){if(typeof r=="string"||typeof r=="number")return{t:r.toString(),d:!0};if("vR"in r&&(r={tag:r.tag,props:r.props,key:r.key,f:r.f,type:r.tag,ref:r.props.ref,o:r.o||r}),typeof r.tag=="function")r[I]=[0,[]];else{const a=Ft[r.tag];a&&(Re||(Re=ga("")),r.props.children=[{tag:Re,props:{value:r.n=`http://www.w3.org/${a}`,children:r.props.children}}])}return r}},Xr=(r,a)=>{var t,i;(t=a[I][2])==null||t.forEach(([n,o])=>{n.values.push(o)});try{Ir(r,a,void 0)}catch{return}if(a.a){delete a.a;return}(i=a[I][2])==null||i.forEach(([n])=>{n.values.pop()}),(r[0]!==1||!r[1])&&ja(a,a.c,!1)},De=new WeakMap,Zr=[],or=async(r,a)=>{r[5]||(r[5]=[]);const t=De.get(a);t&&t[0](void 0);let i;const n=new Promise(o=>i=o);if(De.set(a,[i,()=>{r[2]?r[2](r,a,o=>{Xr(o,a)}).then(()=>i(a)):(Xr(r,a),i(a))}]),Zr.length)Zr.at(-1).add(a);else{await Promise.resolve();const o=De.get(a);o&&(De.delete(a),o[1]())}return n},Kt=(r,a,t)=>({tag:Ue,props:{children:r},key:t,e:a,p:1}),wr=0,Na=1,kr=2,qr=3,Er=new WeakMap,Ua=(r,a)=>!r||!a||r.length!==a.length||a.some((t,i)=>t!==r[i]),Wt=void 0,Qr=[],Xt=r=>{var l;const a=()=>typeof r=="function"?r():r,t=Ge.at(-1);if(!t)return[a(),()=>{}];const[,i]=t,n=(l=i[I][1])[wr]||(l[wr]=[]),o=i[I][0]++;return n[o]||(n[o]=[a(),s=>{const c=Wt,d=n[o];if(typeof s=="function"&&(s=s(d[0])),!Object.is(s,d[0]))if(d[0]=s,Qr.length){const[h,g]=Qr.at(-1);Promise.all([h===3?i:or([h,!1,c],i),g]).then(([f])=>{if(!f||!(h===2||h===3))return;const u=f.vC;requestAnimationFrame(()=>{setTimeout(()=>{u===f.vC&&or([h===3?1:0,!1,c],f)})})})}else or([0,!1,c],i)}])},Pr=(r,a)=>{var s;const t=Ge.at(-1);if(!t)return r;const[,i]=t,n=(s=i[I][1])[kr]||(s[kr]=[]),o=i[I][0]++,l=n[o];return Ua(l==null?void 0:l[1],a)?n[o]=[r,a]:r=n[o][0],r},Zt=r=>{const a=Er.get(r);if(a){if(a.length===2)throw a[1];return a[0]}throw r.then(t=>Er.set(r,[t]),t=>Er.set(r,[void 0,t])),r},Qt=(r,a)=>{var s;const t=Ge.at(-1);if(!t)return r();const[,i]=t,n=(s=i[I][1])[qr]||(s[qr]=[]),o=i[I][0]++,l=n[o];return Ua(l==null?void 0:l[1],a)&&(n[o]=[r(),a]),n[o][0]},ei=ga({pending:!1,data:null,method:null,action:null}),ea=new Set,ri=r=>{ea.add(r),r.finally(()=>ea.delete(r))},Dr=(r,a)=>Qt(()=>t=>{let i;r&&(typeof r=="function"?i=r(t)||(()=>{r(null)}):r&&"current"in r&&(r.current=t,i=()=>{r.current=null}));const n=a(t);return()=>{n==null||n(),i==null||i()}},[r]),me=Object.create(null),er=Object.create(null),Xe=(r,a,t,i,n)=>{if(a!=null&&a.itemProp)return{tag:r,props:a,type:r,ref:a.ref};const o=document.head;let{onLoad:l,onError:s,precedence:c,blocking:d,...h}=a,g=null,f=!1;const u=cr[r],v=ua(r,i),b=E=>E.getAttribute("rel")==="stylesheet"&&E.getAttribute(oe)!==null;let x;if(v){const E=o.querySelectorAll(r);e:for(const C of E)if(!(r==="link"&&!b(C))){for(const S of u)if(C.getAttribute(S)===a[S]){g=C;break e}}if(!g){const C=u.reduce((S,z)=>a[z]===void 0?S:`${S}-${z}-${a[z]}`,r);f=!er[C],g=er[C]||(er[C]=(()=>{const S=document.createElement(r);for(const z of u)a[z]!==void 0&&S.setAttribute(z,a[z]);return a.rel&&S.setAttribute("rel",a.rel),S})())}}else x=o.querySelectorAll(r);c=i?c??"":void 0,i&&(h[oe]=c);const q=Pr(E=>{if(v){if(r==="link"&&c!==void 0){let S=!1;for(const z of o.querySelectorAll(r)){const F=z.getAttribute(oe);if(F===null){o.insertBefore(E,z);return}if(S&&F!==c){o.insertBefore(E,z);return}F===c&&(S=!0)}o.appendChild(E);return}let C=!1;for(const S of o.querySelectorAll(r)){if(C&&S.getAttribute(oe)!==c){o.insertBefore(E,S);return}S.getAttribute(oe)===c&&(C=!0)}o.appendChild(E)}else if(r==="link")o.contains(E)||o.appendChild(E);else if(x){let C=!1;for(const S of x)if(S===E){C=!0;break}C||o.insertBefore(E,o.contains(x[0])?x[0]:o.querySelector(r)),x=void 0}},[v,c,r]),k=Dr(a.ref,E=>{var z;const C=u[0];if(t===2&&(E.innerHTML=""),(f||x)&&q(E),!s&&!l||!C)return;let S=me[z=E.getAttribute(C)]||(me[z]=new Promise((F,Ze)=>{E.addEventListener("load",F),E.addEventListener("error",Ze)}));l&&(S=S.then(l)),s&&(S=S.catch(s)),S.catch(()=>{})});if(n&&d==="render"){const E=cr[r][0];if(E&&a[E]){const C=a[E],S=me[C]||(me[C]=new Promise((z,F)=>{q(g),g.addEventListener("load",z),g.addEventListener("error",F)}));Zt(S)}}const O={tag:r,type:r,props:{...h,ref:k},ref:k};return O.p=t,g&&(O.e=g),Kt(O,o)},ai=r=>{const a=Bt(),t=a&&Le(a);return t!=null&&t.endsWith("svg")?{tag:"title",props:r,type:"title",ref:r.ref}:Xe("title",r,void 0,!1,!1)},ti=r=>!r||["src","async"].some(a=>!r[a])?{tag:"script",props:r,type:"script",ref:r.ref}:Xe("script",r,1,!1,!0),ii=r=>!r||!["href","precedence"].every(a=>a in r)?{tag:"style",props:r,type:"style",ref:r.ref}:(r["data-href"]=r.href,delete r.href,Xe("style",r,2,!0,!0)),ni=r=>!r||["onLoad","onError"].some(a=>a in r)||r.rel==="stylesheet"&&(!("precedence"in r)||"disabled"in r)?{tag:"link",props:r,type:"link",ref:r.ref}:Xe("link",r,1,fa(r),!0),oi=r=>Xe("meta",r,void 0,!1,!1),Ga=Symbol(),li=r=>{const{action:a,...t}=r;typeof a!="function"&&(t.action=a);const[i,n]=Xt([null,!1]),o=Pr(async d=>{const h=d.isTrusted?a:d.detail[Ga];if(typeof h!="function")return;d.preventDefault();const g=new FormData(d.target);n([g,!0]);const f=h(g);f instanceof Promise&&(ri(f),await f),n([null,!0])},[]),l=Dr(r.ref,d=>(d.addEventListener("submit",o),()=>{d.removeEventListener("submit",o)})),[s,c]=i;return i[1]=!1,{tag:ei,props:{value:{pending:s!==null,data:s,method:s?"post":null,action:s?a:null},children:{tag:"form",props:{...t,ref:l},type:"form",ref:l}},f:c}},Fa=(r,{formAction:a,...t})=>{if(typeof a=="function"){const i=Pr(n=>{n.preventDefault(),n.currentTarget.form.dispatchEvent(new CustomEvent("submit",{detail:{[Ga]:a}}))},[]);t.ref=Dr(t.ref,n=>(n.addEventListener("click",i),()=>{n.removeEventListener("click",i)}))}return{tag:r,props:t,type:r,ref:t.ref}},si=r=>Fa("input",r),ci=r=>Fa("button",r);Object.assign(Sr,{title:ai,script:ti,style:ii,link:ni,meta:oi,form:li,input:si,button:ci});Lr(null);var ra=new TextEncoder,di=(r,a=console.trace)=>{let t=!1;return new ReadableStream({async start(n){var o;try{r instanceof H&&(r=r.toString());const l=typeof r=="object"?r:{},s=await lr(r,we.BeforeStream,!0,l);t||n.enqueue(ra.encode(s));let c=0;const d=[],h=g=>{d.push(g.catch(f=>(console.log(f),a(f),"")).then(async f=>{var u;f=await lr(f,we.BeforeStream,!0,l),(u=f.callbacks)==null||u.map(v=>v({phase:we.Stream,context:l})).filter(Boolean).forEach(h),c++,t||n.enqueue(ra.encode(f))}))};for((o=s.callbacks)==null||o.map(g=>g({phase:we.Stream,context:l})).filter(Boolean).forEach(h);c!==d.length;)await Promise.all(d)}catch(l){a(l)}t||n.close()},cancel(){t=!0}})},pi=Lr(null),hi=(r,a,t,i)=>(n,o)=>{i=typeof i=="function"?i(r):i;const l=typeof(i==null?void 0:i.docType)=="string"?i.docType:(i==null?void 0:i.docType)===!1?"":"<!DOCTYPE html>",s=t?Fr(d=>t(d,r),{Layout:a,...o},n):n,c=_a`${D(l)}${Fr(pi.Provider,{value:r},s)}`;if(i!=null&&i.stream){if(i.stream===!0)r.header("Transfer-Encoding","chunked"),r.header("Content-Type","text/html; charset=UTF-8"),r.header("Content-Encoding","Identity");else for(const[d,h]of Object.entries(i.stream))r.header(d,h);return r.body(di(c))}else return r.html(c)},gi=(r,a)=>function(i,n){const o=i.getLayout()??ge;return r&&i.setLayout(l=>r({...l,Layout:o},i)),i.setRenderer(hi(i,o,r,a)),n()};const fi=gi(({children:r})=>e("html",{lang:"en",dir:"ltr",children:[e("head",{children:[e("meta",{charset:"UTF-8"}),e("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),e("title",{children:"HARLEM GROUP — Quality You Deserve!"}),e("meta",{name:"description",content:"Harlem Group — Beacon of excellence since 1995. Automotive, Real Estate, Luxury Watches & Jewellery, Management Consultation."}),e("link",{rel:"icon",type:"image/png",href:"/static/logo-black.png"}),e("link",{rel:"shortcut icon",href:"/static/logo-black.png"}),e("link",{rel:"preconnect",href:"https://fonts.googleapis.com"}),e("link",{rel:"preconnect",href:"https://fonts.gstatic.com",crossorigin:""}),e("link",{href:"https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,200;0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;1,9..40,300;1,9..40,400&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600&display=swap",rel:"stylesheet"}),e("style",{dangerouslySetInnerHTML:{__html:`
/* ═══════════════════════════════════════════════
...
(function(){
  ...
  els.forEach(function(el){ io.observe(el); });
      ...
      `}})]})));const aa=new Ta,ui=Object.assign({"/src/index.tsx":te});let Ba=!1;for(const[,r]of Object.entries(ui))r&&(aa.route("/",r),aa.notFound(r.notFoundHandler),Ba=!0);if(!Ba)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{aa as default};
