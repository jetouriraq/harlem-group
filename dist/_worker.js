...
(function(){
  ...
  els.forEach(function(el){ io.observe(el); });
      ...
      `}})]})));const aa=new ja,ui=Object.assign({"/src/index.tsx":te});let Ba=!1;for(const[,r]of Object.entries(ui))r&&(aa.route("/",r),aa.notFound(r.notFoundHandler),Ba=!0);if(!Ba)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{aa as default};
