var Ja=Object.defineProperty;var Dr=r=>{throw TypeError(r)};var _a=(r,a,t)=>a in r?Ja(r,a,{enumerable:!0,configurable:!0,writable:!0,value:t}):r[a]=t;var m=(r,a,t)=>_a(r,typeof a!="symbol"?a+"":a,t),ur=(r,a,t)=>a.has(r)||Dr("Cannot "+t);var p=(r,a,t)=>(ur(r,a,"read from private field"),t?t.call(r):a.get(r)),w=(r,a,t)=>a.has(r)?Dr("Cannot add the same private member more than once"):a instanceof WeakSet?a.add(r):a.set(r,t),y=(r,a,t,i)=>(ur(r,a,"write to private field"),i?i.call(r,t):a.set(r,t),t),A=(r,a,t)=>(ur(r,a,"access private method"),t);var Hr=(r,a,t,i)=>({set _(n){y(r,a,n,t)},get _(){return p(r,a,i)}});var we={Stringify:1,BeforeStream:2,Stream:3},T=(r,a)=>{const t=new String(r);return t.isEscaped=!0,t.callbacks=a,t},Ya=/[&<>'"]/,ca=async(r,a)=>{let t="";a||(a=[]);const i=await Promise.all(r);for(let n=i.length-1;t+=i[n],n--,!(n<0);n--){let o=i[n];typeof o=="object"&&a.push(...o.callbacks||[]);const l=o.isEscaped;if(o=await(typeof o=="object"?o.toString():o),typeof o=="object"&&a.push(...o.callbacks||[]),o.isEscaped??l)t+=o;else{const s=[t];te(o,s),t=s[0]}}return T(t,a)},te=(r,a)=>{const t=r.search(Ya);if(t===-1){a[0]+=r;return}let i,n,o=0;for(n=t;n<r.length;n++){switch(r.charCodeAt(n)){case 34:i="&quot;";break;case 39:i="&#39;";break;case 38:i="&amp;";break;case 60:i="&lt;";break;case 62:i="&gt;";break;default:continue}a[0]+=r.substring(o,n)+i,o=n+1}a[0]+=r.substring(o,n)},da=r=>{const a=r.callbacks;if(!(a!=null&&a.length))return r;const t=[r],i={};return a.forEach(n=>n({phase:we.Stringify,buffer:t,context:i})),t[0]},lr=async(r,a,t,i,n)=>{typeof r=="object"&&!(r instanceof String)&&(r instanceof Promise||(r=r.toString()),r instanceof Promise&&(r=await r));const o=r.callbacks;if(!(o!=null&&o.length))return Promise.resolve(r);n?n[0]+=r:n=[r];const l=Promise.all(o.map(s=>s({phase:a,buffer:n,context:i}))).then(s=>Promise.all(s.filter(Boolean).map(c=>lr(c,a,!1,i,n))).then(()=>n[0]));return t?T(await l,o):l},$a=(r,...a)=>{const t=[""];for(let i=0,n=r.length-1;i<n;i++){t[0]+=r[i];const o=Array.isArray(a[i])?a[i].flat(1/0):[a[i]];for(let l=0,s=o.length;l<s;l++){const c=o[l];if(typeof c=="string")te(c,t);else if(typeof c=="number")t[0]+=c;else{if(typeof c=="boolean"||c===null||c===void 0)continue;if(typeof c=="object"&&c.isEscaped)if(c.callbacks)t.unshift("",c);else{const d=c.toString();d instanceof Promise?t.unshift("",d):t[0]+=d}else c instanceof Promise?t.unshift("",c):te(c.toString(),t)}}}return t[0]+=r.at(-1),t.length===1?"callbacks"in t?T(da(T(t[0],t.callbacks))):T(t[0]):ca(t,t.callbacks)},Rr=Symbol("RENDERER"),Ar=Symbol("ERROR_HANDLER"),I=Symbol("STASH"),pa=Symbol("INTERNAL"),Va=Symbol("MEMO"),sr=Symbol("PERMALINK"),Nr=r=>(r[pa]=!0,r),ha=r=>({value:a,children:t})=>{if(!t)return;const i={children:[{tag:Nr(()=>{r.push(a)}),props:{}}]};Array.isArray(t)?i.children.push(...t.flat()):i.children.push(t),i.children.push({tag:Nr(()=>{r.pop()}),props:{}});const n={tag:"",props:i,type:""};return n[Ar]=o=>{throw r.pop(),o},n},ga=r=>{const a=[r],t=ha(a);return t.values=a,t.Provider=t,Ie.push(t),t},Ie=[],Lr=r=>{const a=[r],t=(i=>{a.push(i.value);let n;try{n=i.children?(Array.isArray(i.children)?new xa("",{},i.children):i.children).toString():""}catch(o){throw a.pop(),o}return n instanceof Promise?n.finally(()=>a.pop()).then(o=>T(o,o.callbacks)):(a.pop(),T(n))});return t.values=a,t.Provider=t,t[Rr]=ha(a),Ie.push(t),t},Le=r=>r.values.at(-1),cr={title:[],script:["src"],style:["data-href"],link:["href"],meta:["name","httpEquiv","charset","itemProp"]},Sr={},le="data-precedence",fa=r=>r.rel==="stylesheet"&&"precedence"in r,ua=(r,a)=>r==="link"?a:cr[r].length>0,Ve=r=>Array.isArray(r)?r:[r],Ur=new WeakMap,Gr=(r,a,t,i)=>({buffer:n,context:o})=>{if(!n)return;const l=Ur.get(o)||{};Ur.set(o,l);const s=l[r]||(l[r]=[]);let c=!1;const d=cr[r],h=ua(r,i!==void 0);if(h){e:for(const[,g]of s)if(!(r==="link"&&!(g.rel==="stylesheet"&&g[le]!==void 0))){for(const f of d)if(((g==null?void 0:g[f])??null)===(t==null?void 0:t[f])){c=!0;break e}}}if(c?n[0]=n[0].replaceAll(a,""):h||r==="link"?s.push([a,t,i]):s.unshift([a,t,i]),n[0].indexOf("</head>")!==-1){let g;if(r==="link"||i!==void 0){const f=[];g=s.map(([u,,v],b)=>{if(v===void 0)return[u,Number.MAX_SAFE_INTEGER,b];let x=f.indexOf(v);return x===-1&&(f.push(v),x=f.length-1),[u,x,b]}).sort((u,v)=>u[1]-v[1]||u[2]-v[2]).map(([u])=>u)}else g=s.map(([f])=>f);g.forEach(f=>{n[0]=n[0].replaceAll(f,"")}),n[0]=n[0].replace(/(?=<\/head>)/,g.join(""))}},Ke=(r,a,t)=>T(new H(r,t,Ve(a??[])).toString()),We=(r,a,t,i)=>{if("itemProp"in t)return Ke(r,a,t);let{precedence:n,blocking:o,...l}=t;n=i?n??"":void 0,i&&(l[le]=n);const s=new H(r,l,Ve(a||[])).toString();return s instanceof Promise?s.then(c=>T(s,[...c.callbacks||[],Gr(r,c,l,n)])):T(s,[Gr(r,s,l,n)])},Ka=({children:r,...a})=>{const t=Or();if(t){const i=Le(t);if(i==="svg"||i==="head")return new H("title",a,Ve(r??[]))}return We("title",r,a,!1)},Wa=({children:r,...a})=>{const t=Or();return["src","async"].some(i=>!a[i])||t&&Le(t)==="head"?Ke("script",r,a):We("script",r,a,!1)},Xa=({children:r,...a})=>["href","precedence"].every(t=>t in a)?(a["data-href"]=a.href,delete a.href,We("style",r,a,!0)):Ke("style",r,a),Qa=({children:r,...a})=>["onLoad","onError"].some(t=>t in a)||a.rel==="stylesheet"&&(!("precedence"in a)||"disabled"in a)?Ke("link",r,a):We("link",r,a,fa(a)),Za=({children:r,...a})=>{const t=Or();return t&&Le(t)==="head"?Ke("meta",r,a):We("meta",r,a,!1)},va=(r,{children:a,...t})=>new H(r,t,Ve(a??[])),et=r=>(typeof r.action=="function"&&(r.action=sr in r.action?r.action[sr]:void 0),va("form",r)),ma=(r,a)=>(typeof a.formAction=="function"&&(a.formAction=sr in a.formAction?a.formAction[sr]:void 0),va(r,a)),rt=r=>ma("input",r),at=r=>ma("button",r);const vr=Object.freeze(Object.defineProperty({__proto__:null,button:at,form:et,input:rt,link:Qa,meta:Za,script:Wa,style:Xa,title:Ka},Symbol.toStringTag,{value:"Module"}));var tt=new Map([["className","class"],["htmlFor","for"],["crossOrigin","crossorigin"],["httpEquiv","http-equiv"],["itemProp","itemprop"],["fetchPriority","fetchpriority"],["noModule","nomodule"],["formAction","formaction"]]),dr=r=>tt.get(r)||r,ba=(r,a)=>{for(const[t,i]of Object.entries(r)){const n=t[0]==="-"||!/[A-Z]/.test(t)?t:t.replace(/[A-Z]/g,o=>`-${o.toLowerCase()}`);a(n,i==null?null:typeof i=="number"?n.match(/^(?:a|border-im|column(?:-c|s)|flex(?:$|-[^b])|grid-(?:ar|[^a])|font-w|li|or|sca|st|ta|wido|z)|ty$/)?`${i}`:`${i}px`:i)}},Ne=void 0,Or=()=>Ne,it=r=>/[A-Z]/.test(r)&&r.match(/^(?:al|basel|clip(?:Path|Rule)$|co|do|fill|fl|fo|gl|let|lig|i|marker[EMS]|o|pai|pointe|sh|st[or]|text[^L]|tr|u|ve|w)/)?r.replace(/([A-Z])/g,"-$1").toLowerCase():r,nt=["area","base","br","col","embed","hr","img","input","keygen","link","meta","param","source","track","wbr"],ot=["allowfullscreen","async","autofocus","autoplay","checked","controls","default","defer","disabled","download","formnovalidate","hidden","inert","ismap","itemscope","loop","multiple","muted","nomodule","novalidate","open","playsinline","readonly","required","reversed","selected"],jr=(r,a)=>{for(let t=0,i=r.length;t<i;t++){const n=r[t];if(typeof n=="string")te(n,a);else{if(typeof n=="boolean"||n===null||n===void 0)continue;n instanceof H?n.toStringToBuffer(a):typeof n=="number"||n.isEscaped?a[0]+=n:n instanceof Promise?a.unshift("",n):jr(n,a)}}},H=class{constructor(r,a,t){m(this,"tag");m(this,"props");m(this,"key");m(this,"children");m(this,"isEscaped",!0);m(this,"localContexts");this.tag=r,this.props=a,this.children=t}get type(){return this.tag}get ref(){return this.props.ref||null}toString(){var a,t;const r=[""];(a=this.localContexts)==null||a.forEach(([i,n])=>{i.values.push(n)});try{this.toStringToBuffer(r)}finally{(t=this.localContexts)==null||t.forEach(([i])=>{i.values.pop()})}return r.length===1?"callbacks"in r?da(T(r[0],r.callbacks)).toString():r[0]:ca(r,r.callbacks)}toStringToBuffer(r){const a=this.tag,t=this.props;let{children:i}=this;r[0]+=`<${a}`;const n=Ne&&Le(Ne)==="svg"?o=>it(dr(o)):o=>dr(o);for(let[o,l]of Object.entries(t))if(o=n(o),o!=="children"){if(o==="style"&&typeof l=="object"){let s="";ba(l,(c,d)=>{d!=null&&(s+=`${s?";":""}${c}:${d}`)}),r[0]+=' style="',te(s,r),r[0]+='"'}else if(typeof l=="string")r[0]+=` ${o}="`,te(l,r),r[0]+='"';else if(l!=null)if(typeof l=="number"||l.isEscaped)r[0]+=` ${o}="${l}"`;else if(typeof l=="boolean"&&ot.includes(o))l&&(r[0]+=` ${o}=""`);else if(o==="dangerouslySetInnerHTML"){if(i.length>0)throw new Error("Can only set one of `children` or `props.dangerouslySetInnerHTML`.");i=[T(l.__html)]}else if(l instanceof Promise)r[0]+=` ${o}="`,r.unshift('"',l);else if(typeof l=="function"){if(!o.startsWith("on")&&o!=="ref")throw new Error(`Invalid prop '${o}' of type 'function' supplied to '${a}'.`)}else r[0]+=` ${o}="`,te(l.toString(),r),r[0]+='"'}if(nt.includes(a)&&i.length===0){r[0]+="/>";return}r[0]+=">",jr(i,r),r[0]+=`</${a}>`}},mr=class extends H{toStringToBuffer(r){const{children:a}=this,t={...this.props};a.length&&(t.children=a.length===1?a[0]:a);const i=this.tag.call(null,t);if(!(typeof i=="boolean"||i==null))if(i instanceof Promise)if(Ie.length===0)r.unshift("",i);else{const n=Ie.map(o=>[o,o.values.at(-1)]);r.unshift("",i.then(o=>(o instanceof H&&(o.localContexts=n),o)))}else i instanceof H?i.toStringToBuffer(r):typeof i=="number"||i.isEscaped?(r[0]+=i,i.callbacks&&(r.callbacks||(r.callbacks=[]),r.callbacks.push(...i.callbacks))):te(i,r)}},xa=class extends H{toStringToBuffer(r){jr(this.children,r)}},Br=(r,a,...t)=>{a??(a={}),t.length&&(a.children=t.length===1?t[0]:t);const i=a.key;delete a.key;const n=rr(r,a,t);return n.key=i,n},Fr=!1,rr=(r,a,t)=>{if(!Fr){for(const i in Sr)vr[i][Rr]=Sr[i];Fr=!0}return typeof r=="function"?new mr(r,a,t):vr[r]?new mr(vr[r],a,t):r==="svg"||r==="head"?(Ne||(Ne=Lr("")),new H(r,a,[new mr(Ne,{value:r},t)])):new H(r,a,t)},ie=({children:r})=>new xa("",{children:r},Array.isArray(r)?r:r?[r]:[]);function e(r,a,t){let i;if(!a||!("children"in a))i=rr(r,a,[]);else{const n=a.children;i=Array.isArray(n)?rr(r,a,n):rr(r,a,[n])}return i.key=t,i}var Jr=(r,a,t)=>(i,n)=>{let o=-1;return l(0);async function l(s){if(s<=o)throw new Error("next() called multiple times");o=s;let c,d=!1,h;if(r[s]?(h=r[s][0][0],i.req.routeIndex=s):h=s===r.length&&n||void 0,h)try{c=await h(i,()=>l(s+1))}catch(g){if(g instanceof Error&&a)i.error=g,c=await a(g,i),d=!0;else throw g}else i.finalized===!1&&t&&(c=await t(i));return c&&(i.finalized===!1||d)&&(i.res=c),i}},lt=Symbol(),st=async(r,a=Object.create(null))=>{const{all:t=!1,dot:i=!1}=a,o=(r instanceof Aa?r.raw.headers:r.headers).get("Content-Type");return o!=null&&o.startsWith("multipart/form-data")||o!=null&&o.startsWith("application/x-www-form-urlencoded")?ct(r,{all:t,dot:i}):{}};async function ct(r,a){const t=await r.formData();return t?dt(t,a):{}}function dt(r,a){const t=Object.create(null);return r.forEach((i,n)=>{a.all||n.endsWith("[]")?pt(t,n,i):t[n]=i}),a.dot&&Object.entries(t).forEach(([i,n])=>{i.includes(".")&&(ht(t,i,n),delete t[i])}),t}var pt=(r,a,t)=>{r[a]!==void 0?Array.isArray(r[a])?r[a].push(t):r[a]=[r[a],t]:a.endsWith("[]")?r[a]=[t]:r[a]=t},ht=(r,a,t)=>{if(/(?:^|\.)__proto__\./.test(a))return;let i=r;const n=a.split(".");n.forEach((o,l)=>{l===n.length-1?i[o]=t:((!i[o]||typeof i[o]!="object"||Array.isArray(i[o])||i[o]instanceof File)&&(i[o]=Object.create(null)),i=i[o])})},ya=r=>{const a=r.split("/");return a[0]===""&&a.shift(),a},gt=r=>{const{groups:a,path:t}=ft(r),i=ya(t);return ut(i,a)},ft=r=>{const a=[];return r=r.replace(/\{[^}]+\}/g,(t,i)=>{const n=`@${i}`;return a.push([n,t]),n}),{groups:a,path:r}},ut=(r,a)=>{for(let t=a.length-1;t>=0;t--){const[i]=a[t];for(let n=r.length-1;n>=0;n--)if(r[n].includes(i)){r[n]=r[n].replace(i,a[t][1]);break}}return r},Ze={},vt=(r,a)=>{if(r==="*")return"*";const t=r.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);if(t){const i=`${r}#${a}`;return Ze[i]||(t[2]?Ze[i]=a&&a[0]!==":"&&a[0]!=="*"?[i,t[1],new RegExp(`^${t[2]}(?=/${a})`)]:[r,t[1],new RegExp(`^${t[2]}$`)]:Ze[i]=[r,t[1],!0]),Ze[i]}return null},Mr=(r,a)=>{try{return a(r)}catch{return r.replace(/(?:%[0-9A-Fa-f]{2})+/g,t=>{try{return a(t)}catch{return t}})}},mt=r=>Mr(r,decodeURI),wa=r=>{const a=r.url,t=a.indexOf("/",a.indexOf(":")+4);let i=t;for(;i<a.length;i++){const n=a.charCodeAt(i);if(n===37){const o=a.indexOf("?",i),l=a.indexOf("#",i),s=o===-1?l===-1?void 0:l:l===-1?o:Math.min(o,l),c=a.slice(t,s);return mt(c.includes("%25")?c.replace(/%25/g,"%2525"):c)}else if(n===63||n===35)break}return a.slice(t,i)},bt=r=>{const a=wa(r);return a.length>1&&a.at(-1)==="/"?a.slice(0,-1):a},be=(r,a,...t)=>(t.length&&(a=be(a,...t)),`${(r==null?void 0:r[0])==="/"?"":"/"}${r}${a==="/"?"":`${(r==null?void 0:r.at(-1))==="/"?"":"/"}${(a==null?void 0:a[0])==="/"?a.slice(1):a}`}`),ka=r=>{if(r.charCodeAt(r.length-1)!==63||!r.includes(":"))return null;const a=r.split("/"),t=[];let i="";return a.forEach(n=>{if(n!==""&&!/\:/.test(n))i+="/"+n;else if(/\:/.test(n))if(/\?/.test(n)){t.length===0&&i===""?t.push("/"):t.push(i);const o=n.replace("?","");i+="/"+o,t.push(i)}else i+="/"+n}),t.filter((n,o,l)=>l.indexOf(n)===o)},br=r=>/[%+]/.test(r)?(r.indexOf("+")!==-1&&(r=r.replace(/\+/g," ")),r.indexOf("%")!==-1?Mr(r,qa):r):r,Ea=(r,a,t)=>{let i;if(!t&&a&&!/[%+]/.test(a)){let l=r.indexOf("?",8);if(l===-1)return;for(r.startsWith(a,l+1)||(l=r.indexOf(`&${a}`,l+1));l!==-1;){const s=r.charCodeAt(l+a.length+1);if(s===61){const c=l+a.length+2,d=r.indexOf("&",c);return br(r.slice(c,d===-1?void 0:d))}else if(s==38||isNaN(s))return"";l=r.indexOf(`&${a}`,l+1)}if(i=/[%+]/.test(r),!i)return}const n={};i??(i=/[%+]/.test(r));let o=r.indexOf("?",8);for(;o!==-1;){const l=r.indexOf("&",o+1);let s=r.indexOf("=",o);s>l&&l!==-1&&(s=-1);let c=r.slice(o+1,s===-1?l===-1?void 0:l:s);if(i&&(c=br(c)),o=l,c==="")continue;let d;s===-1?d="":(d=r.slice(s+1,l===-1?void 0:l),i&&(d=br(d))),t?(n[c]&&Array.isArray(n[c])||(n[c]=[]),n[c].push(d)):n[c]??(n[c]=d)}return a?n[a]:n},xt=Ea,yt=(r,a)=>Ea(r,a,!0),qa=decodeURIComponent,_r=r=>Mr(r,qa),ke,D,K,Sa,Ca,Cr,X,ta,Aa=(ta=class{constructor(r,a="/",t=[[]]){w(this,K);m(this,"raw");w(this,ke);w(this,D);m(this,"routeIndex",0);m(this,"path");m(this,"bodyCache",{});w(this,X,r=>{const{bodyCache:a,raw:t}=this,i=a[r];if(i)return i;const n=Object.keys(a)[0];return n?a[n].then(o=>(n==="json"&&(o=JSON.stringify(o)),new Response(o)[r]())):a[r]=t[r]()});this.raw=r,this.path=a,y(this,D,t),y(this,ke,{})}param(r){return r?A(this,K,Sa).call(this,r):A(this,K,Ca).call(this)}query(r){return xt(this.url,r)}queries(r){return yt(this.url,r)}header(r){if(r)return this.raw.headers.get(r)??void 0;const a={};return this.raw.headers.forEach((t,i)=>{a[i]=t}),a}async parseBody(r){var a;return(a=this.bodyCache).parsedBody??(a.parsedBody=await st(this,r))}json(){return p(this,X).call(this,"text").then(r=>JSON.parse(r))}text(){return p(this,X).call(this,"text")}arrayBuffer(){return p(this,X).call(this,"arrayBuffer")}blob(){return p(this,X).call(this,"blob")}formData(){return p(this,X).call(this,"formData")}addValidatedData(r,a){p(this,ke)[r]=a}valid(r){return p(this,ke)[r]}get url(){return this.raw.url}get method(){return this.raw.method}get[lt](){return p(this,D)}get matchedRoutes(){return p(this,D)[0].map(([[,r]])=>r)}get routePath(){return p(this,D)[0].map(([[,r]])=>r)[this.routeIndex].path}},ke=new WeakMap,D=new WeakMap,K=new WeakSet,Sa=function(r){const a=p(this,D)[0][this.routeIndex][1][r],t=A(this,K,Cr).call(this,a);return t&&/\%/.test(t)?_r(t):t},Ca=function(){const r={},a=Object.keys(p(this,D)[0][this.routeIndex][1]);for(const t of a){const i=A(this,K,Cr).call(this,p(this,D)[0][this.routeIndex][1][t]);i!==void 0&&(r[t]=/\%/.test(i)?_r(i):i)}return r},Cr=function(r){return p(this,D)[1]?p(this,D)[1][r]:r},X=new WeakMap,ta),wt="text/plain; charset=UTF-8",xr=(r,a)=>({"Content-Type":r,...a}),Me=(r,a)=>new Response(r,a),Be,Fe,_,Ee,Y,P,Je,qe,Ae,se,_e,Ye,Q,xe,ia,kt=(ia=class{constructor(r,a){w(this,Q);w(this,Be);w(this,Fe);m(this,"env",{});w(this,_);m(this,"finalized",!1);m(this,"error");w(this,Ee);w(this,Y);w(this,P);w(this,Je);w(this,qe);w(this,Ae);w(this,se);w(this,_e);w(this,Ye);m(this,"render",(...r)=>(p(this,qe)??y(this,qe,a=>this.html(a)),p(this,qe).call(this,...r)));m(this,"setLayout",r=>y(this,Je,r));m(this,"getLayout",()=>p(this,Je));m(this,"setRenderer",r=>{y(this,qe,r)});m(this,"header",(r,a,t)=>{this.finalized&&y(this,P,Me(p(this,P).body,p(this,P)));const i=p(this,P)?p(this,P).headers:p(this,se)??y(this,se,new Headers);a===void 0?i.delete(r):t!=null&&t.append?i.append(r,a):i.set(r,a)});m(this,"status",r=>{y(this,Ee,r)});m(this,"set",(r,a)=>{p(this,_)??y(this,_,new Map),p(this,_).set(r,a)});m(this,"get",r=>p(this,_)?p(this,_).get(r):void 0);m(this,"newResponse",(...r)=>A(this,Q,xe).call(this,...r));m(this,"body",(r,a,t)=>A(this,Q,xe).call(this,r,a,t));m(this,"text",(r,a,t)=>!p(this,se)&&!p(this,Ee)&&!a&&!t&&!this.finalized?new Response(r):A(this,Q,xe).call(this,r,a,xr(wt,t)));m(this,"json",(r,a,t)=>A(this,Q,xe).call(this,JSON.stringify(r),a,xr("application/json",t)));m(this,"html",(r,a,t)=>{const i=n=>A(this,Q,xe).call(this,n,a,xr("text/html; charset=UTF-8",t));return typeof r=="object"?lr(r,we.Stringify,!1,{}).then(i):i(r)});m(this,"redirect",(r,a)=>{const t=String(r);return this.header("Location",/[^\x00-\xFF]/.test(t)?encodeURI(t):t),this.newResponse(null,a??302)});m(this,"notFound",()=>(p(this,Ae)??y(this,Ae,()=>Me()),p(this,Ae).call(this,this)));y(this,Be,r),a&&(y(this,Y,a.executionCtx),this.env=a.env,y(this,Ae,a.notFoundHandler),y(this,Ye,a.path),y(this,_e,a.matchResult))}get req(){return p(this,Fe)??y(this,Fe,new Aa(p(this,Be),p(this,Ye),p(this,_e))),p(this,Fe)}get event(){if(p(this,Y)&&"respondWith"in p(this,Y))return p(this,Y);throw Error("This context has no FetchEvent")}get executionCtx(){if(p(this,Y))return p(this,Y);throw Error("This context has no ExecutionContext")}get res(){return p(this,P)||y(this,P,Me(null,{headers:p(this,se)??y(this,se,new Headers)}))}set res(r){if(p(this,P)&&r){r=Me(r.body,r);for(const[a,t]of p(this,P).headers.entries())if(a!=="content-type")if(a==="set-cookie"){const i=p(this,P).headers.getSetCookie();r.headers.delete("set-cookie");for(const n of i)r.headers.append("set-cookie",n)}else r.headers.set(a,t)}y(this,P,r),this.finalized=!0}get var(){return p(this,_)?Object.fromEntries(p(this,_)):{}}},Be=new WeakMap,Fe=new WeakMap,_=new WeakMap,Ee=new WeakMap,Y=new WeakMap,P=new WeakMap,Je=new WeakMap,qe=new WeakMap,Ae=new WeakMap,se=new WeakMap,_e=new WeakMap,Ye=new WeakMap,Q=new WeakSet,xe=function(r,a,t){const i=p(this,P)?new Headers(p(this,P).headers):p(this,se)??new Headers;if(typeof a=="object"&&"headers"in a){const o=a.headers instanceof Headers?a.headers:new Headers(a.headers);for(const[l,s]of o)l.toLowerCase()==="set-cookie"?i.append(l,s):i.set(l,s)}if(t)for(const[o,l]of Object.entries(t))if(typeof l=="string")i.set(o,l);else{i.delete(o);for(const s of l)i.append(o,s)}const n=typeof a=="number"?a:(a==null?void 0:a.status)??p(this,Ee);return Me(r,{status:n,headers:i})},ia),R="ALL",Et="all",qt=["get","post","put","delete","options","patch"],za="Can not add a route since the matcher is already built.",Ia=class extends Error{},At="__COMPOSED_HANDLER",St=r=>r.text("404 Not Found",404),Yr=(r,a)=>{if("getResponse"in r){const t=r.getResponse();return a.newResponse(t.body,t)}return console.error(r),a.text("Internal Server Error",500)},N,L,Ra,U,ne,ar,tr,Se,Ct=(Se=class{constructor(a={}){w(this,L);m(this,"get");m(this,"post");m(this,"put");m(this,"delete");m(this,"options");m(this,"patch");m(this,"all");m(this,"on");m(this,"use");m(this,"router");m(this,"getPath");m(this,"_basePath","/");w(this,N,"/");m(this,"routes",[]);w(this,U,St);m(this,"errorHandler",Yr);m(this,"onError",a=>(this.errorHandler=a,this));m(this,"notFound",a=>(y(this,U,a),this));m(this,"fetch",(a,...t)=>A(this,L,tr).call(this,a,t[1],t[0],a.method));m(this,"request",(a,t,i,n)=>a instanceof Request?this.fetch(t?new Request(a,t):a,i,n):(a=a.toString(),this.fetch(new Request(/^https?:\/\//.test(a)?a:`http://localhost${be("/",a)}`,t),i,n)));m(this,"fire",()=>{addEventListener("fetch",a=>{a.respondWith(A(this,L,tr).call(this,a.request,a,void 0,a.request.method))})});[...qt,Et].forEach(o=>{this[o]=(l,...s)=>(typeof l=="string"?y(this,N,l):A(this,L,ne).call(this,o,p(this,N),l),s.forEach(c=>{A(this,L,ne).call(this,o,p(this,N),c)}),this)}),this.on=(o,l,...s)=>{for(const c of[l].flat()){y(this,N,c);for(const d of[o].flat())s.map(h=>{A(this,L,ne).call(this,d.toUpperCase(),p(this,N),h)})}return this},this.use=(o,...l)=>(typeof o=="string"?y(this,N,o):(y(this,N,"*"),l.unshift(o)),l.forEach(s=>{A(this,L,ne).call(this,R,p(this,N),s)}),this);const{strict:i,...n}=a;Object.assign(this,n),this.getPath=i??!0?a.getPath??wa:bt}route(a,t){const i=this.basePath(a);return t.routes.map(n=>{var l;let o;t.errorHandler===Yr?o=n.handler:(o=async(s,c)=>(await Jr([],t.errorHandler)(s,()=>n.handler(s,c))).res,o[At]=n.handler),A(l=i,L,ne).call(l,n.method,n.path,o)}),this}basePath(a){const t=A(this,L,Ra).call(this);return t._basePath=be(this._basePath,a),t}mount(a,t,i){let n,o;i&&(typeof i=="function"?o=i:(o=i.optionHandler,i.replaceRequest===!1?n=c=>c:n=i.replaceRequest));const l=o?c=>{const d=o(c);return Array.isArray(d)?d:[d]}:c=>{let d;try{d=c.executionCtx}catch{}return[c.env,d]};n||(n=(()=>{const c=be(this._basePath,a),d=c==="/"?0:c.length;return h=>{const g=new URL(h.url);return g.pathname=g.pathname.slice(d)||"/",new Request(g,h)}})());const s=async(c,d)=>{const h=await t(n(c.req.raw),...l(c));if(h)return h;await d()};return A(this,L,ne).call(this,R,be(a,"*"),s),this}},N=new WeakMap,L=new WeakSet,Ra=function(){const a=new Se({router:this.router,getPath:this.getPath});return a.errorHandler=this.errorHandler,y(a,U,p(this,U)),a.routes=this.routes,a},U=new WeakMap,ne=function(a,t,i){a=a.toUpperCase(),t=be(this._basePath,t);const n={basePath:this._basePath,path:t,method:a,handler:i};this.router.add(a,t,[i,n]),this.routes.push(n)},ar=function(a,t){if(a instanceof Error)return this.errorHandler(a,t);throw a},tr=function(a,t,i,n){if(n==="HEAD")return(async()=>new Response(null,await A(this,L,tr).call(this,a,t,i,"GET")))();const o=this.getPath(a,{env:i}),l=this.router.match(n,o),s=new kt(a,{path:o,matchResult:l,env:i,executionCtx:t,notFoundHandler:p(this,U)});if(l[0].length===1){let d;try{d=l[0][0][0][0](s,async()=>{s.res=await p(this,U).call(this,s)})}catch(h){return A(this,L,ar).call(this,h,s)}return d instanceof Promise?d.then(h=>h||(s.finalized?s.res:p(this,U).call(this,s))).catch(h=>A(this,L,ar).call(this,h,s)):d??p(this,U).call(this,s)}const c=Jr(l[0],this.errorHandler,p(this,U));return(async()=>{try{const d=await c(s);if(!d.finalized)throw new Error("Context is not finalized. Did you forget to return a Response object or `await next()`?");return d.res}catch(d){return A(this,L,ar).call(this,d,s)}})()},Se),La=[];function zt(r,a){const t=this.buildAllMatchers(),i=((n,o)=>{const l=t[n]||t[R],s=l[2][o];if(s)return s;const c=o.match(l[0]);if(!c)return[[],La];const d=c.indexOf("",1);return[l[1][d],c]});return this.match=i,i(r,a)}var pr="[^/]+",De=".*",He="(?:|/.*)",ye=Symbol(),It=new Set(".\\+*[^]$()");function Rt(r,a){return r.length===1?a.length===1?r<a?-1:1:-1:a.length===1||r===De||r===He?1:a===De||a===He?-1:r===pr?1:a===pr?-1:r.length===a.length?r<a?-1:1:a.length-r.length}var ce,de,G,ge,Lt=(ge=class{constructor(){w(this,ce);w(this,de);w(this,G,Object.create(null))}insert(a,t,i,n,o){if(a.length===0){if(p(this,ce)!==void 0)throw ye;if(o)return;y(this,ce,t);return}const[l,...s]=a,c=l==="*"?s.length===0?["","",De]:["","",pr]:l==="/*"?["","",He]:l.match(/^\:([^\{\}]+)(?:\{(.+)\})?$/);let d;if(c){const h=c[1];let g=c[2]||pr;if(h&&c[2]&&(g===".*"||(g=g.replace(/^\((?!\?:)(?=[^)]+\)$)/,"(?:"),/\((?!\?:)/.test(g))))throw ye;if(d=p(this,G)[g],!d){if(Object.keys(p(this,G)).some(f=>f!==De&&f!==He))throw ye;if(o)return;d=p(this,G)[g]=new ge,h!==""&&y(d,de,n.varIndex++)}!o&&h!==""&&i.push([h,p(d,de)])}else if(d=p(this,G)[l],!d){if(Object.keys(p(this,G)).some(h=>h.length>1&&h!==De&&h!==He))throw ye;if(o)return;d=p(this,G)[l]=new ge}d.insert(s,t,i,n,o)}buildRegExpStr(){const t=Object.keys(p(this,G)).sort(Rt).map(i=>{const n=p(this,G)[i];return(typeof p(n,de)=="number"?`(${i})@${p(n,de)}`:It.has(i)?`\\${i}`:i)+n.buildRegExpStr()});return typeof p(this,ce)=="number"&&t.unshift(`#${p(this,ce)}`),t.length===0?"":t.length===1?t[0]:"(?:"+t.join("|")+")"}},ce=new WeakMap,de=new WeakMap,G=new WeakMap,ge),hr,$e,na,Ot=(na=class{constructor(){w(this,hr,{varIndex:0});w(this,$e,new Lt)}insert(r,a,t){const i=[],n=[];for(let l=0;;){let s=!1;if(r=r.replace(/\{[^}]+\}/g,c=>{const d=`@\\${l}`;return n[l]=[d,c],l++,s=!0,d}),!s)break}const o=r.match(/(?::[^\/]+)|(?:\/\*$)|./g)||[];for(let l=n.length-1;l>=0;l--){const[s]=n[l];for(let c=o.length-1;c>=0;c--)if(o[c].indexOf(s)!==-1){o[c]=o[c].replace(s,n[l][1]);break}}return p(this,$e).insert(o,a,i,p(this,hr),t),i}buildRegExp(){let r=p(this,$e).buildRegExpStr();if(r==="")return[/^$/,[],[]];let a=0;const t=[],i=[];return r=r.replace(/#(\d+)|@(\d+)|\.\*\$/g,(n,o,l)=>o!==void 0?(t[++a]=Number(o),"$()"):(l!==void 0&&(i[Number(l)]=++a),"")),[new RegExp(`^${r}`),t,i]}},hr=new WeakMap,$e=new WeakMap,na),jt=[/^$/,[],Object.create(null)],ir=Object.create(null);function Oa(r){return ir[r]??(ir[r]=new RegExp(r==="*"?"":`^${r.replace(/\/\*$|([.\\+*[^\]$()])/g,(a,t)=>t?`\\${t}`:"(?:|/.*)")}$`))}function Mt(){ir=Object.create(null)}function Pt(r){var d;const a=new Ot,t=[];if(r.length===0)return jt;const i=r.map(h=>[!/\*|\/:/.test(h[0]),...h]).sort(([h,g],[f,u])=>h?1:f?-1:g.length-u.length),n=Object.create(null);for(let h=0,g=-1,f=i.length;h<f;h++){const[u,v,b]=i[h];u?n[v]=[b.map(([E])=>[E,Object.create(null)]),La]:g++;let x;try{x=a.insert(v,g,u)}catch(E){throw E===ye?new Ia(v):E}u||(t[g]=b.map(([E,k])=>{const j=Object.create(null);for(k-=1;k>=0;k--){const[q,C]=x[k];j[q]=C}return[E,j]}))}const[o,l,s]=a.buildRegExp();for(let h=0,g=t.length;h<g;h++)for(let f=0,u=t[h].length;f<u;f++){const v=(d=t[h][f])==null?void 0:d[1];if(!v)continue;const b=Object.keys(v);for(let x=0,E=b.length;x<E;x++)v[b[x]]=s[v[b[x]]]}const c=[];for(const h in l)c[h]=t[l[h]];return[o,c,n]}function ve(r,a){if(r){for(const t of Object.keys(r).sort((i,n)=>n.length-i.length))if(Oa(t).test(a))return[...r[t]]}}var Z,ee,gr,ja,oa,Tt=(oa=class{constructor(){w(this,gr);m(this,"name","RegExpRouter");w(this,Z);w(this,ee);m(this,"match",zt);y(this,Z,{[R]:Object.create(null)}),y(this,ee,{[R]:Object.create(null)})}add(r,a,t){var s;const i=p(this,Z),n=p(this,ee);if(!i||!n)throw new Error(za);i[r]||[i,n].forEach(c=>{c[r]=Object.create(null),Object.keys(c[R]).forEach(d=>{c[r][d]=[...c[R][d]]})}),a==="/*"&&(a="*");const o=(a.match(/\/:/g)||[]).length;if(/\*$/.test(a)){const c=Oa(a);r===R?Object.keys(i).forEach(d=>{var h;(h=i[d])[a]||(h[a]=ve(i[d],a)||ve(i[R],a)||[])}):(s=i[r])[a]||(s[a]=ve(i[r],a)||ve(i[R],a)||[]),Object.keys(i).forEach(d=>{(r===R||r===d)&&Object.keys(i[d]).forEach(h=>{c.test(h)&&i[d][h].push([t,o])})}),Object.keys(n).forEach(d=>{(r===R||r===d)&&Object.keys(n[d]).forEach(h=>c.test(h)&&n[d][h].push([t,o]))});return}const l=ka(a)||[a];for(let c=0,d=l.length;c<d;c++){const h=l[c];Object.keys(n).forEach(g=>{var f;(r===R||r===g)&&((f=n[g])[h]||(f[h]=[...ve(i[g],h)||ve(i[R],h)||[]]),n[g][h].push([t,o-d+c+1]))})}}buildAllMatchers(){const r=Object.create(null);return Object.keys(p(this,ee)).concat(Object.keys(p(this,Z))).forEach(a=>{r[a]||(r[a]=A(this,gr,ja).call(this,a))}),y(this,Z,y(this,ee,void 0)),Mt(),r}},Z=new WeakMap,ee=new WeakMap,gr=new WeakSet,ja=function(r){const a=[];let t=r===R;return[p(this,Z),p(this,ee)].forEach(i=>{const n=i[r]?Object.keys(i[r]).map(o=>[o,i[r][o]]):[];n.length!==0?(t||(t=!0),a.push(...n)):r!==R&&a.push(...Object.keys(i[R]).map(o=>[o,i[R][o]]))}),t?Pt(a):null},oa),re,$,la,Dt=(la=class{constructor(r){m(this,"name","SmartRouter");w(this,re,[]);w(this,$,[]);y(this,re,r.routers)}add(r,a,t){if(!p(this,$))throw new Error(za);p(this,$).push([r,a,t])}match(r,a){if(!p(this,$))throw new Error("Fatal error");const t=p(this,re),i=p(this,$),n=t.length;let o=0,l;for(;o<n;o++){const s=t[o];try{for(let c=0,d=i.length;c<d;c++)s.add(...i[c]);l=s.match(r,a)}catch(c){if(c instanceof Ia)continue;throw c}this.match=s.match.bind(s),y(this,re,[s]),y(this,$,void 0);break}if(o===n)throw new Error("Fatal error");return this.name=`SmartRouter + ${this.activeRouter.name}`,l}get activeRouter(){if(p(this,$)||p(this,re).length!==1)throw new Error("No active router has been determined yet.");return p(this,re)[0]}},re=new WeakMap,$=new WeakMap,la),Pe=Object.create(null),Ht=r=>{for(const a in r)return!0;return!1},ae,M,pe,Ce,O,V,oe,ze,Nt=(ze=class{constructor(a,t,i){w(this,V);w(this,ae);w(this,M);w(this,pe);w(this,Ce,0);w(this,O,Pe);if(y(this,M,i||Object.create(null)),y(this,ae,[]),a&&t){const n=Object.create(null);n[a]={handler:t,possibleKeys:[],score:0},y(this,ae,[n])}y(this,pe,[])}insert(a,t,i){y(this,Ce,++Hr(this,Ce)._);let n=this;const o=gt(t),l=[];for(let s=0,c=o.length;s<c;s++){const d=o[s],h=o[s+1],g=vt(d,h),f=Array.isArray(g)?g[0]:d;if(f in p(n,M)){n=p(n,M)[f],g&&l.push(g[1]);continue}p(n,M)[f]=new ze,g&&(p(n,pe).push(g),l.push(g[1])),n=p(n,M)[f]}return p(n,ae).push({[a]:{handler:i,possibleKeys:l.filter((s,c,d)=>d.indexOf(s)===c),score:p(this,Ce)}}),n}search(a,t){var h;const i=[];y(this,O,Pe);let o=[this];const l=ya(t),s=[],c=l.length;let d=null;for(let g=0;g<c;g++){const f=l[g],u=g===c-1,v=[];for(let x=0,E=o.length;x<E;x++){const k=o[x],j=p(k,M)[f];j&&(y(j,O,p(k,O)),u?(p(j,M)["*"]&&A(this,V,oe).call(this,i,p(j,M)["*"],a,p(k,O)),A(this,V,oe).call(this,i,j,a,p(k,O))):v.push(j));for(let q=0,C=p(k,pe).length;q<C;q++){const S=p(k,pe)[q],z=p(k,O)===Pe?{}:{...p(k,O)};if(S==="*"){const fe=p(k,M)["*"];fe&&(A(this,V,oe).call(this,i,fe,a,p(k,O)),y(fe,O,z),v.push(fe));continue}const[B,Qe,Oe]=S;if(!f&&!(Oe instanceof RegExp))continue;const F=p(k,M)[B];if(Oe instanceof RegExp){if(d===null){d=new Array(c);let ue=t[0]==="/"?1:0;for(let je=0;je<c;je++)d[je]=ue,ue+=l[je].length+1}const fe=t.substring(d[g]),fr=Oe.exec(fe);if(fr){if(z[Qe]=fr[0],A(this,V,oe).call(this,i,F,a,p(k,O),z),Ht(p(F,M))){y(F,O,z);const ue=((h=fr[0].match(/\//))==null?void 0:h.length)??0;(s[ue]||(s[ue]=[])).push(F)}continue}}(Oe===!0||Oe.test(f))&&(z[Qe]=f,u?(A(this,V,oe).call(this,i,F,a,z,p(k,O)),p(F,M)["*"]&&A(this,V,oe).call(this,i,p(F,M)["*"],a,z,p(k,O))):(y(F,O,z),v.push(F)))}}const b=s.shift();o=b?v.concat(b):v}return i.length>1&&i.sort((g,f)=>g.score-f.score),[i.map(({handler:g,params:f})=>[g,f])]}},ae=new WeakMap,M=new WeakMap,pe=new WeakMap,Ce=new WeakMap,O=new WeakMap,V=new WeakSet,oe=function(a,t,i,n,o){for(let l=0,s=p(t,ae).length;l<s;l++){const c=p(t,ae)[l],d=c[i]||c[R],h={};if(d!==void 0&&(d.params=Object.create(null),a.push(d),n!==Pe||o&&o!==Pe))for(let g=0,f=d.possibleKeys.length;g<f;g++){const u=d.possibleKeys[g],v=h[d.score];d.params[u]=o!=null&&o[u]&&!v?o[u]:n[u]??(o==null?void 0:o[u]),h[d.score]=!0}}},ze),he,sa,Ut=(sa=class{constructor(){m(this,"name","TrieRouter");w(this,he);y(this,he,new Nt)}add(r,a,t){const i=ka(a);if(i){for(let n=0,o=i.length;n<o;n++)p(this,he).insert(r,i[n],t);return}p(this,he).insert(r,a,t)}match(r,a){return p(this,he).search(r,a)}},he=new WeakMap,sa),Ma=class extends Ct{constructor(r={}){super(r),this.router=r.router??new Dt({routers:[new Tt,new Ut]})}},Ue="_hp",Gt={Change:"Input",DoubleClick:"DblClick"},Bt={svg:"2000/svg",math:"1998/Math/MathML"},Ge=[],zr=new WeakMap,Re=void 0,Ft=()=>Re,J=r=>"t"in r,yr={onClick:["click",!1]},$r=r=>{if(!r.startsWith("on"))return;if(yr[r])return yr[r];const a=r.match(/^on([A-Z][a-zA-Z]+?(?:PointerCapture)?)(Capture)?$/);if(a){const[,t,i]=a;return yr[r]=[(Gt[t]||t).toLowerCase(),!!i]}},Vr=(r,a)=>Re&&r instanceof SVGElement&&/[A-Z]/.test(a)&&(a in r.style||a.match(/^(?:o|pai|str|u|ve)/))?a.replace(/([A-Z])/g,"-$1").toLowerCase():a,Jt=(r,a,t)=>{var i;a||(a={});for(let n in a){const o=a[n];if(n!=="children"&&(!t||t[n]!==o)){n=dr(n);const l=$r(n);if(l){if((t==null?void 0:t[n])!==o&&(t&&r.removeEventListener(l[0],t[n],l[1]),o!=null)){if(typeof o!="function")throw new Error(`Event handler for "${n}" is not a function`);r.addEventListener(l[0],o,l[1])}}else if(n==="dangerouslySetInnerHTML"&&o)r.innerHTML=o.__html;else if(n==="ref"){let s;typeof o=="function"?s=o(r)||(()=>o(null)):o&&"current"in o&&(o.current=r,s=()=>o.current=null),zr.set(r,s)}else if(n==="style"){const s=r.style;typeof o=="string"?s.cssText=o:(s.cssText="",o!=null&&ba(o,s.setProperty.bind(s)))}else{if(n==="value"){const c=r.nodeName;if(c==="INPUT"||c==="TEXTAREA"||c==="SELECT"){if(r.value=o==null||o===!1?null:o,c==="TEXTAREA"){r.textContent=o;continue}else if(c==="SELECT"){r.selectedIndex===-1&&(r.selectedIndex=0);continue}}}else(n==="checked"&&r.nodeName==="INPUT"||n==="selected"&&r.nodeName==="OPTION")&&(r[n]=o);const s=Vr(r,n);o==null||o===!1?r.removeAttribute(s):o===!0?r.setAttribute(s,""):typeof o=="string"||typeof o=="number"?r.setAttribute(s,o):r.setAttribute(s,o.toString())}}}if(t)for(let n in t){const o=t[n];if(n!=="children"&&!(n in a)){n=dr(n);const l=$r(n);l?r.removeEventListener(l[0],o,l[1]):n==="ref"?(i=zr.get(r))==null||i():r.removeAttribute(Vr(r,n))}}},_t=(r,a)=>{a[I][0]=0,Ge.push([r,a]);const t=a.tag[Rr]||a.tag,i=t.defaultProps?{...t.defaultProps,...a.props}:a.props;try{return[t.call(null,i)]}finally{Ge.pop()}},Pa=(r,a,t,i,n)=>{var o,l;(o=r.vR)!=null&&o.length&&(i.push(...r.vR),delete r.vR),typeof r.tag=="function"&&((l=r[I][1][Na])==null||l.forEach(s=>n.push(s))),r.vC.forEach(s=>{var c;if(J(s))t.push(s);else if(typeof s.tag=="function"||s.tag===""){s.c=a;const d=t.length;if(Pa(s,a,t,i,n),s.s){for(let h=d;h<t.length;h++)t[h].s=!0;s.s=!1}}else t.push(s),(c=s.vR)!=null&&c.length&&(i.push(...s.vR),delete s.vR)})},Yt=r=>{var a;for(;r&&(r.tag===Ue||!r.e);)r=r.tag===Ue||!((a=r.vC)!=null&&a[0])?r.nN:r.vC[0];return r==null?void 0:r.e},Ta=r=>{var a,t,i,n,o,l;J(r)||((t=(a=r[I])==null?void 0:a[1][Na])==null||t.forEach(s=>{var c;return(c=s[2])==null?void 0:c.call(s)}),(i=zr.get(r.e))==null||i(),r.p===2&&((n=r.vC)==null||n.forEach(s=>s.p=2)),(o=r.vC)==null||o.forEach(Ta)),r.p||((l=r.e)==null||l.remove(),delete r.e),typeof r.tag=="function"&&(Te.delete(r),nr.delete(r),delete r[I][3],r.a=!0)},Da=(r,a,t)=>{r.c=a,Ha(r,a,t)},Kr=(r,a)=>{if(a){for(let t=0,i=r.length;t<i;t++)if(r[t]===a)return t}},Wr=Symbol(),Ha=(r,a,t)=>{var d;const i=[],n=[],o=[];Pa(r,a,i,n,o),n.forEach(Ta);const l=t?void 0:a.childNodes;let s,c=null;if(t)s=-1;else if(!l.length)s=0;else{const h=Kr(l,Yt(r.nN));h!==void 0?(c=l[h],s=h):s=Kr(l,(d=i.find(g=>g.tag!==Ue&&g.e))==null?void 0:d.e)??-1,s===-1&&(t=!0)}for(let h=0,g=i.length;h<g;h++,s++){const f=i[h];let u;if(f.s&&f.e)u=f.e,f.s=!1;else{const v=t||!f.e;J(f)?(f.e&&f.d&&(f.e.textContent=f.t),f.d=!1,u=f.e||(f.e=document.createTextNode(f.t))):(u=f.e||(f.e=f.n?document.createElementNS(f.n,f.tag):document.createElement(f.tag)),Jt(u,f.props,f.pP),Ha(f,u,v))}f.tag===Ue?s--:t?u.parentNode||a.appendChild(u):l[s]!==u&&l[s-1]!==u&&(l[s+1]===u?a.appendChild(l[s]):a.insertBefore(u,c||l[s]||null))}if(r.pP&&(r.pP=void 0),o.length){const h=[],g=[];o.forEach(([,f,,u,v])=>{f&&h.push(f),u&&g.push(u),v==null||v()}),h.forEach(f=>f()),g.length&&requestAnimationFrame(()=>{g.forEach(f=>f())})}},$t=(r,a)=>!!(r&&r.length===a.length&&r.every((t,i)=>t[1]===a[i][1])),nr=new WeakMap,Ir=(r,a,t)=>{var o,l,s,c,d,h;const i=!t&&a.pC;t&&(a.pC||(a.pC=a.vC));let n;try{t||(t=typeof a.tag=="function"?_t(r,a):Ve(a.props.children)),((o=t[0])==null?void 0:o.tag)===""&&t[0][Ar]&&(n=t[0][Ar],r[5].push([r,n,a]));const g=i?[...a.pC]:a.vC?[...a.vC]:void 0,f=[];let u;for(let v=0;v<t.length;v++){if(Array.isArray(t[v])){t.splice(v,1,...t[v].flat(1/0)),v--;continue}let b=Vt(t[v]);if(b){typeof b.tag=="function"&&!b.tag[pa]&&(Ie.length>0&&(b[I][2]=Ie.map(E=>[E,E.values.at(-1)])),(l=r[5])!=null&&l.length&&(b[I][3]=r[5].at(-1)));let x;if(g&&g.length){const E=g.findIndex(J(b)?k=>J(k):b.key!==void 0?k=>k.key===b.key&&k.tag===b.tag:k=>k.tag===b.tag);E!==-1&&(x=g[E],g.splice(E,1))}if(x)if(J(b))x.t!==b.t&&(x.t=b.t,x.d=!0),b=x;else{const E=x.pP=x.props;if(x.props=b.props,x.f||(x.f=b.f||a.f),typeof b.tag=="function"){const k=x[I][2];x[I][2]=b[I][2]||[],x[I][3]=b[I][3],!x.f&&((x.o||x)===b.o||(c=(s=x.tag)[Va])!=null&&c.call(s,E,x.props))&&$t(k,x[I][2])&&(x.s=!0)}b=x}else if(!J(b)&&Re){const E=Le(Re);E&&(b.n=E)}if(!J(b)&&!b.s&&(Ir(r,b),delete b.f),f.push(b),u&&!u.s&&!b.s)for(let E=u;E&&!J(E);E=(d=E.vC)==null?void 0:d.at(-1))E.nN=b;u=b}}a.vR=i?[...a.vC,...g||[]]:g||[],a.vC=f,i&&delete a.pC}catch(g){if(a.f=!0,g===Wr){if(n)return;throw g}const[f,u,v]=((h=a[I])==null?void 0:h[3])||[];if(u){const b=()=>or([0,!1,r[2]],v),x=nr.get(v)||[];x.push(b),nr.set(v,x);const E=u(g,()=>{const k=nr.get(v);if(k){const j=k.indexOf(b);if(j!==-1)return k.splice(j,1),b()}});if(E){if(r[0]===1)r[1]=!0;else if(Ir(r,v,[E]),(u.length===1||r!==f)&&v.c){Da(v,v.c,!1);return}throw Wr}}throw g}finally{n&&r[5].pop()}},Vt=r=>{if(!(r==null||typeof r=="boolean")){if(typeof r=="string"||typeof r=="number")return{t:r.toString(),d:!0};if("vR"in r&&(r={tag:r.tag,props:r.props,key:r.key,f:r.f,type:r.tag,ref:r.props.ref,o:r.o||r}),typeof r.tag=="function")r[I]=[0,[]];else{const a=Bt[r.tag];a&&(Re||(Re=ga("")),r.props.children=[{tag:Re,props:{value:r.n=`http://www.w3.org/${a}`,children:r.props.children}}])}return r}},Xr=(r,a)=>{var t,i;(t=a[I][2])==null||t.forEach(([n,o])=>{n.values.push(o)});try{Ir(r,a,void 0)}catch{return}if(a.a){delete a.a;return}(i=a[I][2])==null||i.forEach(([n])=>{n.values.pop()}),(r[0]!==1||!r[1])&&Da(a,a.c,!1)},Te=new WeakMap,Qr=[],or=async(r,a)=>{r[5]||(r[5]=[]);const t=Te.get(a);t&&t[0](void 0);let i;const n=new Promise(o=>i=o);if(Te.set(a,[i,()=>{r[2]?r[2](r,a,o=>{Xr(o,a)}).then(()=>i(a)):(Xr(r,a),i(a))}]),Qr.length)Qr.at(-1).add(a);else{await Promise.resolve();const o=Te.get(a);o&&(Te.delete(a),o[1]())}return n},Kt=(r,a,t)=>({tag:Ue,props:{children:r},key:t,e:a,p:1}),wr=0,Na=1,kr=2,Er=3,qr=new WeakMap,Ua=(r,a)=>!r||!a||r.length!==a.length||a.some((t,i)=>t!==r[i]),Wt=void 0,Zr=[],Xt=r=>{var l;const a=()=>typeof r=="function"?r():r,t=Ge.at(-1);if(!t)return[a(),()=>{}];const[,i]=t,n=(l=i[I][1])[wr]||(l[wr]=[]),o=i[I][0]++;return n[o]||(n[o]=[a(),s=>{const c=Wt,d=n[o];if(typeof s=="function"&&(s=s(d[0])),!Object.is(s,d[0]))if(d[0]=s,Zr.length){const[h,g]=Zr.at(-1);Promise.all([h===3?i:or([h,!1,c],i),g]).then(([f])=>{if(!f||!(h===2||h===3))return;const u=f.vC;requestAnimationFrame(()=>{setTimeout(()=>{u===f.vC&&or([h===3?1:0,!1,c],f)})})})}else or([0,!1,c],i)}])},Pr=(r,a)=>{var s;const t=Ge.at(-1);if(!t)return r;const[,i]=t,n=(s=i[I][1])[kr]||(s[kr]=[]),o=i[I][0]++,l=n[o];return Ua(l==null?void 0:l[1],a)?n[o]=[r,a]:r=n[o][0],r},Qt=r=>{const a=qr.get(r);if(a){if(a.length===2)throw a[1];return a[0]}throw r.then(t=>qr.set(r,[t]),t=>qr.set(r,[void 0,t])),r},Zt=(r,a)=>{var s;const t=Ge.at(-1);if(!t)return r();const[,i]=t,n=(s=i[I][1])[Er]||(s[Er]=[]),o=i[I][0]++,l=n[o];return Ua(l==null?void 0:l[1],a)&&(n[o]=[r(),a]),n[o][0]},ei=ga({pending:!1,data:null,method:null,action:null}),ea=new Set,ri=r=>{ea.add(r),r.finally(()=>ea.delete(r))},Tr=(r,a)=>Zt(()=>t=>{let i;r&&(typeof r=="function"?i=r(t)||(()=>{r(null)}):r&&"current"in r&&(r.current=t,i=()=>{r.current=null}));const n=a(t);return()=>{n==null||n(),i==null||i()}},[r]),me=Object.create(null),er=Object.create(null),Xe=(r,a,t,i,n)=>{if(a!=null&&a.itemProp)return{tag:r,props:a,type:r,ref:a.ref};const o=document.head;let{onLoad:l,onError:s,precedence:c,blocking:d,...h}=a,g=null,f=!1;const u=cr[r],v=ua(r,i),b=q=>q.getAttribute("rel")==="stylesheet"&&q.getAttribute(le)!==null;let x;if(v){const q=o.querySelectorAll(r);e:for(const C of q)if(!(r==="link"&&!b(C))){for(const S of u)if(C.getAttribute(S)===a[S]){g=C;break e}}if(!g){const C=u.reduce((S,z)=>a[z]===void 0?S:`${S}-${z}-${a[z]}`,r);f=!er[C],g=er[C]||(er[C]=(()=>{const S=document.createElement(r);for(const z of u)a[z]!==void 0&&S.setAttribute(z,a[z]);return a.rel&&S.setAttribute("rel",a.rel),S})())}}else x=o.querySelectorAll(r);c=i?c??"":void 0,i&&(h[le]=c);const E=Pr(q=>{if(v){if(r==="link"&&c!==void 0){let S=!1;for(const z of o.querySelectorAll(r)){const B=z.getAttribute(le);if(B===null){o.insertBefore(q,z);return}if(S&&B!==c){o.insertBefore(q,z);return}B===c&&(S=!0)}o.appendChild(q);return}let C=!1;for(const S of o.querySelectorAll(r)){if(C&&S.getAttribute(le)!==c){o.insertBefore(q,S);return}S.getAttribute(le)===c&&(C=!0)}o.appendChild(q)}else if(r==="link")o.contains(q)||o.appendChild(q);else if(x){let C=!1;for(const S of x)if(S===q){C=!0;break}C||o.insertBefore(q,o.contains(x[0])?x[0]:o.querySelector(r)),x=void 0}},[v,c,r]),k=Tr(a.ref,q=>{var z;const C=u[0];if(t===2&&(q.innerHTML=""),(f||x)&&E(q),!s&&!l||!C)return;let S=me[z=q.getAttribute(C)]||(me[z]=new Promise((B,Qe)=>{q.addEventListener("load",B),q.addEventListener("error",Qe)}));l&&(S=S.then(l)),s&&(S=S.catch(s)),S.catch(()=>{})});if(n&&d==="render"){const q=cr[r][0];if(q&&a[q]){const C=a[q],S=me[C]||(me[C]=new Promise((z,B)=>{E(g),g.addEventListener("load",z),g.addEventListener("error",B)}));Qt(S)}}const j={tag:r,type:r,props:{...h,ref:k},ref:k};return j.p=t,g&&(j.e=g),Kt(j,o)},ai=r=>{const a=Ft(),t=a&&Le(a);return t!=null&&t.endsWith("svg")?{tag:"title",props:r,type:"title",ref:r.ref}:Xe("title",r,void 0,!1,!1)},ti=r=>!r||["src","async"].some(a=>!r[a])?{tag:"script",props:r,type:"script",ref:r.ref}:Xe("script",r,1,!1,!0),ii=r=>!r||!["href","precedence"].every(a=>a in r)?{tag:"style",props:r,type:"style",ref:r.ref}:(r["data-href"]=r.href,delete r.href,Xe("style",r,2,!0,!0)),ni=r=>!r||["onLoad","onError"].some(a=>a in r)||r.rel==="stylesheet"&&(!("precedence"in r)||"disabled"in r)?{tag:"link",props:r,type:"link",ref:r.ref}:Xe("link",r,1,fa(r),!0),oi=r=>Xe("meta",r,void 0,!1,!1),Ga=Symbol(),li=r=>{const{action:a,...t}=r;typeof a!="function"&&(t.action=a);const[i,n]=Xt([null,!1]),o=Pr(async d=>{const h=d.isTrusted?a:d.detail[Ga];if(typeof h!="function")return;d.preventDefault();const g=new FormData(d.target);n([g,!0]);const f=h(g);f instanceof Promise&&(ri(f),await f),n([null,!0])},[]),l=Tr(r.ref,d=>(d.addEventListener("submit",o),()=>{d.removeEventListener("submit",o)})),[s,c]=i;return i[1]=!1,{tag:ei,props:{value:{pending:s!==null,data:s,method:s?"post":null,action:s?a:null},children:{tag:"form",props:{...t,ref:l},type:"form",ref:l}},f:c}},Ba=(r,{formAction:a,...t})=>{if(typeof a=="function"){const i=Pr(n=>{n.preventDefault(),n.currentTarget.form.dispatchEvent(new CustomEvent("submit",{detail:{[Ga]:a}}))},[]);t.ref=Tr(t.ref,n=>(n.addEventListener("click",i),()=>{n.removeEventListener("click",i)}))}return{tag:r,props:t,type:r,ref:t.ref}},si=r=>Ba("input",r),ci=r=>Ba("button",r);Object.assign(Sr,{title:ai,script:ti,style:ii,link:ni,meta:oi,form:li,input:si,button:ci});Lr(null);var ra=new TextEncoder,di=(r,a=console.trace)=>{let t=!1;return new ReadableStream({async start(n){var o;try{r instanceof H&&(r=r.toString());const l=typeof r=="object"?r:{},s=await lr(r,we.BeforeStream,!0,l);t||n.enqueue(ra.encode(s));let c=0;const d=[],h=g=>{d.push(g.catch(f=>(console.log(f),a(f),"")).then(async f=>{var u;f=await lr(f,we.BeforeStream,!0,l),(u=f.callbacks)==null||u.map(v=>v({phase:we.Stream,context:l})).filter(Boolean).forEach(h),c++,t||n.enqueue(ra.encode(f))}))};for((o=s.callbacks)==null||o.map(g=>g({phase:we.Stream,context:l})).filter(Boolean).forEach(h);c!==d.length;)await Promise.all(d)}catch(l){a(l)}t||n.close()},cancel(){t=!0}})},pi=Lr(null),hi=(r,a,t,i)=>(n,o)=>{i=typeof i=="function"?i(r):i;const l=typeof(i==null?void 0:i.docType)=="string"?i.docType:(i==null?void 0:i.docType)===!1?"":"<!DOCTYPE html>",s=t?Br(d=>t(d,r),{Layout:a,...o},n):n,c=$a`${T(l)}${Br(pi.Provider,{value:r},s)}`;if(i!=null&&i.stream){if(i.stream===!0)r.header("Transfer-Encoding","chunked"),r.header("Content-Type","text/html; charset=UTF-8"),r.header("Content-Encoding","Identity");else for(const[d,h]of Object.entries(i.stream))r.header(d,h);return r.body(di(c))}else return r.html(c)},gi=(r,a)=>function(i,n){const o=i.getLayout()??ie;return r&&i.setLayout(l=>r({...l,Layout:o},i)),i.setRenderer(hi(i,o,r,a)),n()};const fi=gi(({children:r})=>e("html",{lang:"en",dir:"ltr",children:[e("head",{children:[e("meta",{charset:"UTF-8"}),e("meta",{name:"viewport",content:"width=device-width, initial-scale=1.0"}),e("title",{children:"HARLEM GROUP — Quality You Deserve!"}),e("meta",{name:"description",content:"Harlem Group — Beacon of excellence since 1995. Automotive, Real Estate, Luxury Watches & Jewellery, Management Consultation."}),e("link",{rel:"icon",type:"image/png",href:"/static/logo-black.png"}),e("link",{rel:"shortcut icon",href:"/static/logo-black.png"}),e("link",{rel:"preconnect",href:"https://fonts.googleapis.com"}),e("link",{rel:"preconnect",href:"https://fonts.gstatic.com",crossorigin:""}),e("link",{href:"https://fonts.googleapis.com/css2?family=DM+Sans:ital,opsz,wght@0,9..40,200;0,9..40,300;0,9..40,400;0,9..40,500;0,9..40,600;0,9..40,700;1,9..40,300;1,9..40,400&family=Playfair+Display:ital,wght@0,400;0,500;0,600;0,700;1,400;1,500;1,600&display=swap",rel:"stylesheet"}),e("style",{dangerouslySetInnerHTML:{__html:`
/* ═══════════════════════════════════════════════
...
(function(){
  ...
  els.forEach(function(el){ io.observe(el); });
      ...
      `}})]})));W.get("/contact",r=>r.render(e(ie,{children:[e("nav",{id:"nav",class:"scrolled nav-dark",children:[e("a",{href:"/",class:"nav-logo",children:e("img",{src:"/static/logo-white.png",alt:"Harlem Group",id:"navLogo"})}),e("div",{class:"nav-links",children:[e("div",{class:"nav-item",children:[e("a",{href:"/#founder",class:"nav-a",children:"About"}),e("span",{class:"nav-drop-arrow",children:"▾"}),e("div",{class:"nav-dropdown",children:[e("a",{href:"/purpose",class:"nav-drop-link",children:"Our Purpose"}),e("a",{href:"/highlights",class:"nav-drop-link",children:"Highlights"}),e("a",{href:"/#divisions",class:"nav-drop-link",children:"Divisions"})]})]}),e("a",{href:"/#brands",class:"nav-a",children:"Partners"}),e("a",{href:"/locations",class:"nav-a",children:"Locations"}),e("a",{href:"/news",class:"nav-a",children:"News"}),e("a",{href:"/careers",class:"nav-a",children:"Careers"})]}),e("div",{class:"nav-right",children:[e("a",{href:"/contact",class:"nav-cta active",children:"Get in Touch"}),e("button",{class:"hamburger",id:"fsBtn","aria-label":"Open menu",children:[e("span",{}),e("span",{}),e("span",{})]})]})]}),e("section",{class:"cp-hero",children:[e("div",{class:"cp-hero-bg"}),e("div",{class:"cp-hero-grid"}),e("div",{class:"cp-hero-rings","aria-hidden":"true",children:[e("div",{class:"cp-hero-ring"}),e("div",{class:"cp-hero-ring"}),e("div",{class:"cp-hero-ring"})]}),e("div",{class:"container cp-hero-inner",children:[e("div",{class:"tag on-dark r",children:"Get in Touch"}),e("h1",{class:"cp-hero-h1 r d1",children:["Let's ",e("em",{children:"Connect"})]}),e("p",{class:"cp-hero-sub r d2",children:"Whether you're looking for partnership opportunities, have questions about our brands, or simply want to learn more — we're here and happy to hear from you."})]})]}),e("div",{class:"cp-info-strip",children:e("div",{class:"container",children:e("div",{class:"cp-info-grid",children:[e("div",{class:"cp-info-cell r",children:[e("div",{class:"cp-info-icon",children:"✉"}),e("div",{class:"cp-info-lbl",children:"Email"}),e("div",{class:"cp-info-val",children:e("a",{href:"mailto:info@harlem.group",children:"info@harlem.group"})})]}),e("div",{class:"cp-info-cell r d1",children:[e("div",{class:"cp-info-icon",children:"🏢"}),e("div",{class:"cp-info-lbl",children:"Headquarters"}),e("div",{class:"cp-info-val",children:"Erbil, Kurdistan Region, Iraq"})]}),e("div",{class:"cp-info-cell r d2",children:[e("div",{class:"cp-info-icon",children:"🌐"}),e("div",{class:"cp-info-lbl",children:"Operations"}),e("div",{class:"cp-info-val",children:"Iraq · Jordan · UAE · USA"})]}),e("div",{class:"cp-info-cell r d3",children:[e("div",{class:"cp-info-icon",children:"in"}),e("div",{class:"cp-info-lbl",children:"LinkedIn"}),e("div",{class:"cp-info-val",children:e("a",{href:"https://www.linkedin.com/company/harlemgroup",target:"_blank",rel:"noopener",children:"Harlem Group"})})]})]})})}),e("section",{class:"cp-main",children:e("div",{class:"container",children:e("div",{class:"cp-main-grid",children:[e("div",{children:[e("h2",{class:"cp-offices-h2 r",children:["Our ",e("em",{children:"Offices"})]}),e("p",{class:"cp-offices-sub r d1",children:"Harlem Group has been operating since 1995, with regional hubs across four countries. Visit us at any of our offices."}),e("div",{class:"cp-office-list",children:[e("div",{class:"cp-office-card r d1",children:[e("div",{class:"cp-office-flag",children:"🇮🇶"}),e("div",{class:"cp-office-country",children:"Iraq · Headquarters"}),e("div",{class:"cp-office-name",children:"Harlem Group — Iraq HQ"}),e("div",{class:"cp-office-details",children:[e("div",{class:"cp-office-detail",children:[e("strong",{children:"City"})," Erbil, Kurdistan Region"]}),e("div",{class:"cp-office-detail",children:[e("strong",{children:"Also in"})," Baghdad · Kirkuk · Najaf · Sulaymaniyah · Duhok"]}),e("div",{class:"cp-office-detail",children:[e("strong",{children:"Email"})," info@harlem.group"]})]})]}),e("div",{class:"cp-office-card r d2",children:[e("div",{class:"cp-office-flag",children:"🇯🇴"}),e("div",{class:"cp-office-country",children:"Jordan"}),e("div",{class:"cp-office-name",children:"Harlem Group — Jordan"}),e("div",{class:"cp-office-details",children:[e("div",{class:"cp-office-detail",children:[e("strong",{children:"City"})," Amman"]}),e("div",{class:"cp-office-detail",children:[e("strong",{children:"Focus"})," Automotive · Commercial Agencies"]}),e("div",{class:"cp-office-detail",children:[e("strong",{children:"Email"})," info@harlem.group"]})]})]}),e("div",{class:"cp-office-card r d3",children:[e("div",{class:"cp-office-flag",children:"🇦🇪"}),e("div",{class:"cp-office-country",children:"United Arab Emirates"}),e("div",{class:"cp-office-name",children:"Harlem Group — UAE"}),e("div",{class:"cp-office-details",children:[e("div",{class:"cp-office-detail",children:[e("strong",{children:"City"})," Dubai (DUCAMZ)"]}),e("div",{class:"cp-office-detail",children:[e("strong",{children:"Focus"})," Showrooms · Stockyard · Regional Hub"]}),e("div",{class:"cp-office-detail",children:[e("strong",{children:"Email"})," info@harlem.group"]})]})]}),e("div",{class:"cp-office-card r d4",children:[e("div",{class:"cp-office-flag",children:"🇺🇸"}),e("div",{class:"cp-office-country",children:"United States"}),e("div",{class:"cp-office-name",children:"Harlem Group — North America"}),e("div",{class:"cp-office-details",children:[e("div",{class:"cp-office-detail",children:[e("strong",{children:"State"})," Illinois"]}),e("div",{class:"cp-office-detail",children:[e("strong",{children:"Focus"})," Luxury Brands · Car Rental · Real Estate"]}),e("div",{class:"cp-office-detail",children:[e("strong",{children:"Email"})," info@harlem.group"]})]})]})]})]}),e("div",{children:e("div",{class:"cp-form-wrap r",children:[e("h3",{class:"cp-form-h3",children:["Send Us a ",e("em",{children:"Message"})]}),e("p",{class:"cp-form-sub",children:"Fill in the form below and our team will get back to you within 24–48 hours."}),e("form",{id:"cpForm",novalidate:!0,children:[e("div",{class:"cp-form-row",children:[e("input",{type:"text",id:"cpName",class:"cp-input",placeholder:"Full Name *",required:!0}),e("input",{type:"email",id:"cpEmail",class:"cp-input",placeholder:"Email Address *",required:!0})]}),e("div",{class:"cp-form-row",children:[e("input",{type:"text",id:"cpPhone",class:"cp-input",placeholder:"Phone Number"}),e("div",{class:"cp-select-wrap",children:e("select",{id:"cpCountry",class:"cp-input",children:[e("option",{value:"",children:"Country / Office"}),e("option",{value:"iraq",children:"Iraq"}),e("option",{value:"jordan",children:"Jordan"}),e("option",{value:"uae",children:"UAE"}),e("option",{value:"usa",children:"USA"})]})})]}),e("div",{class:"cp-select-wrap",style:"margin-bottom:14px",children:e("select",{id:"cpTopic",class:"cp-input",children:[e("option",{value:"",children:"Topic / Department"}),e("option",{value:"automotive",children:"Automotive — Sales & Agencies"}),e("option",{value:"service",children:"Automotive — After-Sales & Service"}),e("option",{value:"realestate",children:"Real Estate"}),e("option",{value:"consultation",children:"Management Consultation"}),e("option",{value:"careers",children:"Careers & HR"}),e("option",{value:"media",children:"Media & Press"}),e("option",{value:"other",children:"Other"})]})}),e("input",{type:"text",id:"cpSubject",class:"cp-input",placeholder:"Subject *",required:!0,style:"width:100%;margin-bottom:14px;"}),e("textarea",{id:"cpMessage",class:"cp-input cp-textarea",placeholder:"Your message *",required:!0}),e("button",{type:"submit",class:"cp-submit",id:"cpSubmitBtn",children:"Send Message →"}),e("div",{class:"cp-success",id:"cpSuccess",children:["✓  Thank you! Your message has been received.",e("br",{}),"We'll get back to you within 24–48 hours."]})]})]})})]})})}),e("footer",{children:e("div",{class:"container",children:[e("div",{class:"ft-grid",children:[e("div",{children:[e("img",{src:"/static/logo-white.png",alt:"Harlem Group",class:"ft-logo"}),e("div",{class:"ft-slogan",children:"Quality You Deserve!"}),e("p",{class:"ft-about",children:"Harlem Group — a beacon of excellence since 1995. Operating across Automotive, Real Estate, and Management Consultation across Iraq, Jordan, UAE, and USA."}),e("div",{class:"ft-socials",children:e("a",{href:"https://www.linkedin.com/company/harlemgroup",target:"_blank",rel:"noopener",class:"ft-soc","aria-label":"LinkedIn",children:"in"})})]}),e("div",{children:[e("div",{class:"ft-col-h",children:"Divisions"}),e("div",{class:"ft-links",children:[e("a",{href:"/#auto-services",children:"Automotive Division"}),e("a",{href:"/#realestate",children:"Real Estate"}),e("a",{href:"/#consulting",children:"Management Consultation"}),e("a",{href:"/news",children:"News & Stories"})]})]}),e("div",{children:[e("div",{class:"ft-col-h",children:"Company"}),e("div",{class:"ft-links",children:[e("a",{href:"/#founder",children:"About Harlem Group"}),e("a",{href:"/purpose",children:"Vision & Mission"}),e("a",{href:"/highlights",children:"Achievements"}),e("a",{href:"/#brands",children:"Our Partners"}),e("a",{href:"/locations",children:"Locations"}),e("a",{href:"/news",children:"News & Stories"}),e("a",{href:"/contact",children:"Contact"})]})]}),e("div",{children:[e("div",{class:"ft-col-h",children:"Contact"}),e("div",{class:"ft-contact-row",children:[e("div",{children:[e("div",{class:"ft-contact-lbl",children:"Email"}),e("div",{class:"ft-contact-val",children:"info@harlem.group"})]}),e("div",{children:[e("div",{class:"ft-contact-lbl",children:"Operations"}),e("div",{class:"ft-contact-val",children:"Iraq · Jordan · UAE · USA"})]})]})]})]}),e("div",{class:"ft-bottom",children:[e("span",{children:"© 2025 Harlem Group. All rights reserved."}),e("div",{style:"display:flex;gap:28px",children:[e("a",{href:"#",children:"Privacy Policy"}),e("a",{href:"#",children:"Terms of Use"})]})]})]})}),e("script",{dangerouslySetInnerHTML:{__html:`
      ...
      `}})]})));const aa=new Ma,ui=Object.assign({"/src/index.tsx":W});let Fa=!1;for(const[,r]of Object.entries(ui))r&&(aa.route("/",r),aa.notFound(r.notFoundHandler),Fa=!0);if(!Fa)throw new Error("Can't import modules from ['/src/index.tsx','/app/server.ts']");export{aa as default};
